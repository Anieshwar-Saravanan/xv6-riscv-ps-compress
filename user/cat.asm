...
cat(int fd)
{
  ...
  44:	93058593          	addi	a1,a1,-1744 # 970 <malloc+0xfa>
  48:	4509                	li	a0,2
  4a:	74a000ef          	jal	794 <fprintf>
      exit(1);
  4e:	4505                	li	a0,1
  ...
  6e:	91e58593          	addi	a1,a1,-1762 # 988 <malloc+0x112>
  72:	4509                	li	a0,2
  74:	720000ef          	jal	794 <fprintf>
    exit(1);
  78:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  e6:	8be58593          	addi	a1,a1,-1858 # 9a0 <malloc+0x12a>
  ea:	4509                	li	a0,2
  ec:	6a8000ef          	jal	794 <fprintf>
      exit(1);
  f0:	4505                	li	a0,1
...
0000000000000454 <getactiveprocesses>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48c:	0605ce63          	bltz	a1,508 <printint+0x8e>
  neg = 0;
 490:	4e01                	li	t3,0
    x = -xx;
  } else {
 ...
 49e:	52680813          	addi	a6,a6,1318 # 9c0 <digits>
 4a2:	88be                	mv	a7,a5
 ...
 4ec:	854a                	mv	a0,s2
 4ee:	f6fff0ef          	jal	45c <putc>
  while(--i >= 0)
 4f2:	39fd                	addiw	s3,s3,-1
 4f4:	14fd                	addi	s1,s1,-1
 4f6:	fe09d9e3          	bgez	s3,4e8 <printint+0x6e>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51e:	26048663          	beqz	s1,78a <vprintf+0x27a>
 ...
 54a:	a00d                	j	56c <vprintf+0x5c>
        putc(fd, c0);
 54c:	85a6                	mv	a1,s1
 54e:	855a                	mv	a0,s6
 550:	f0dff0ef          	jal	45c <putc>
 554:	a019                	j	55a <vprintf+0x4a>
    } else if(state == '%'){
 556:	03598363          	beq	s3,s5,57c <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
 55a:	0019079b          	addiw	a5,s2,1
 55e:	893e                	mv	s2,a5
 560:	873e                	mv	a4,a5
 562:	97d2                	add	a5,a5,s4
 564:	0007c483          	lbu	s1,0(a5)
 568:	20048963          	beqz	s1,77a <vprintf+0x26a>
    c0 = fmt[i] & 0xff;
 56c:	0004879b          	sext.w	a5,s1
    if(state == 0){
 570:	fe0993e3          	bnez	s3,556 <vprintf+0x46>
      if(c0 == '%'){
 574:	fd579ce3          	bne	a5,s5,54c <vprintf+0x3c>
        state = '%';
 578:	89be                	mv	s3,a5
 57a:	b7c5                	j	55a <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
 ...
 584:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 586:	c681                	beqz	a3,58e <vprintf+0x7e>
 588:	9752                	add	a4,a4,s4
 58a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 58e:	03878e63          	beq	a5,s8,5ca <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
 592:	05978863          	beq	a5,s9,5e2 <vprintf+0xd2>
 ...
 59a:	0ee78263          	beq	a5,a4,67e <vprintf+0x16e>
 ...
 5a2:	12e78463          	beq	a5,a4,6ca <vprintf+0x1ba>
 ...
 5aa:	14e78963          	beq	a5,a4,6fc <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 5ae:	07300713          	li	a4,115
 5b2:	18e78863          	beq	a5,a4,742 <vprintf+0x232>
 ...
 5ba:	04e79463          	bne	a5,a4,602 <vprintf+0xf2>
        putc(fd, '%');
 5be:	85ba                	mv	a1,a4
 5c0:	855a                	mv	a0,s6
 5c2:	e9bff0ef          	jal	45c <putc>
 ...
 606:	855a                	mv	a0,s6
 608:	e55ff0ef          	jal	45c <putc>
        putc(fd, c0);
 60c:	85a6                	mv	a1,s1
 60e:	855a                	mv	a0,s6
 610:	e4dff0ef          	jal	45c <putc>
      state = 0;
 614:	4981                	li	s3,0
 ...
 738:	f4f5                	bnez	s1,724 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
 73a:	8bea                	mv	s7,s10
      state = 0;
 73c:	4981                	li	s3,0
 73e:	6d02                	ld	s10,0(sp)
 740:	bd29                	j	55a <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 742:	008b8993          	addi	s3,s7,8
 746:	000bb483          	ld	s1,0(s7)
 74a:	cc91                	beqz	s1,766 <vprintf+0x256>
        for(; *s; s++)
 74c:	0004c583          	lbu	a1,0(s1)
 750:	c195                	beqz	a1,774 <vprintf+0x264>
          putc(fd, *s);
 752:	855a                	mv	a0,s6
 754:	d09ff0ef          	jal	45c <putc>
        for(; *s; s++)
 758:	0485                	addi	s1,s1,1
 75a:	0004c583          	lbu	a1,0(s1)
 75e:	f9f5                	bnez	a1,752 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
 760:	8bce                	mv	s7,s3
      state = 0;
 762:	4981                	li	s3,0
 764:	bbdd                	j	55a <vprintf+0x4a>
          s = "(null)";
 766:	00000497          	auipc	s1,0x0
 76a:	25248493          	addi	s1,s1,594 # 9b8 <malloc+0x142>
        for(; *s; s++)
 76e:	02800593          	li	a1,40
 772:	b7c5                	j	752 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
 774:	8bce                	mv	s7,s3
      state = 0;
 776:	4981                	li	s3,0
 778:	b3cd                	j	55a <vprintf+0x4a>
...
free(void *ap)
{
 ...
 820:	a091                	j	864 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 822:	6398                	ld	a4,0(a5)
 824:	00e7e463          	bltu	a5,a4,82c <free+0x3c>
 828:	00e6ea63          	bltu	a3,a4,83c <free+0x4c>
{
 82c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 82e:	fed7fae3          	bgeu	a5,a3,822 <free+0x32>
 832:	6398                	ld	a4,0(a5)
 834:	00e6e463          	bltu	a3,a4,83c <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 838:	fee7eae3          	bltu	a5,a4,82c <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
 ...
 84c:	fae60de3          	beq	a2,a4,806 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
 ...
 860:	fae68ae3          	beq	a3,a4,814 <free+0x24>
    p->s.ptr = bp->s.ptr;
 864:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
 ...
 89c:	c905                	beqz	a0,8cc <malloc+0x56>
 ...
 89e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8a0:	4798                	lw	a4,8(a5)
 8a2:	09377663          	bgeu	a4,s3,92e <malloc+0xb8>
 ...
 8ae:	8a4e                	mv	s4,s3
 8b0:	6705                	lui	a4,0x1
 8b2:	00e9f363          	bgeu	s3,a4,8b8 <malloc+0x42>
 8b6:	6a05                	lui	s4,0x1
 ...
 8c4:	74048493          	addi	s1,s1,1856 # 1000 <freep>
  if(p == (char*)-1)
 8c8:	5afd                	li	s5,-1
 8ca:	a83d                	j	908 <malloc+0x92>
 ...
 8e6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 8ea:	b7d1                	j	8ae <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
 8ec:	6398                	ld	a4,0(a5)
 8ee:	e118                	sd	a4,0(a0)
 8f0:	a899                	j	946 <malloc+0xd0>
  hp->s.size = nu;
 8f2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 8f6:	0541                	addi	a0,a0,16
 8f8:	ef9ff0ef          	jal	7f0 <free>
  return freep;
 8fc:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 8fe:	c125                	beqz	a0,95e <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 900:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 902:	4798                	lw	a4,8(a5)
 904:	03277163          	bgeu	a4,s2,926 <malloc+0xb0>
    if(p == freep)
 908:	6098                	ld	a4,0(s1)
 90a:	853e                	mv	a0,a5
 90c:	fef71ae3          	bne	a4,a5,900 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
 910:	8552                	mv	a0,s4
 912:	b0bff0ef          	jal	41c <sbrk>
  if(p == (char*)-1)
 916:	fd551ee3          	bne	a0,s5,8f2 <malloc+0x7c>
        return 0;
 91a:	4501                	li	a0,0
 ...
 920:	6aa2                	ld	s5,8(sp)
 922:	6b02                	ld	s6,0(sp)
 924:	a03d                	j	952 <malloc+0xdc>
 926:	74a2                	ld	s1,40(sp)
 928:	6a42                	ld	s4,16(sp)
 92a:	6aa2                	ld	s5,8(sp)
 92c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 92e:	fae90fe3          	beq	s2,a4,8ec <malloc+0x76>
        p->s.size -= nunits;
