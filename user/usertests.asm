...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	66878793          	addi	a5,a5,1640 # 7678 <malloc+0x2494>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	27450513          	addi	a0,a0,628 # 52e0 <malloc+0xfc>
      74:	0b8050ef          	jal	512c <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	25a50513          	addi	a0,a0,602 # 5300 <malloc+0x11c>
      ae:	07e050ef          	jal	512c <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	25250513          	addi	a0,a0,594 # 5318 <malloc+0x134>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	25c50513          	addi	a0,a0,604 # 5338 <malloc+0x154>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	22850513          	addi	a0,a0,552 # 5320 <malloc+0x13c>
     100:	02c050ef          	jal	512c <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	23c50513          	addi	a0,a0,572 # 5348 <malloc+0x164>
     114:	018050ef          	jal	512c <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	1ee50513          	addi	a0,a0,494 # 5370 <malloc+0x18c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	1e450513          	addi	a0,a0,484 # 5390 <malloc+0x1ac>
     1b4:	779040ef          	jal	512c <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     25e:	15e50513          	addi	a0,a0,350 # 53b8 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     272:	14aa8a93          	addi	s5,s5,330 # 53b8 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	0ec50513          	addi	a0,a0,236 # 53c8 <malloc+0x1e4>
     2e4:	649040ef          	jal	512c <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2fa:	0f250513          	addi	a0,a0,242 # 53e8 <malloc+0x204>
     2fe:	62f040ef          	jal	512c <printf>
        exit(1);
     302:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     320:	0e450513          	addi	a0,a0,228 # 5400 <malloc+0x21c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     334:	0d098993          	addi	s3,s3,208 # 5400 <malloc+0x21c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     370:	09450513          	addi	a0,a0,148 # 5400 <malloc+0x21c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     384:	00858593          	addi	a1,a1,8 # 5388 <malloc+0x1a4>
     388:	19b040ef          	jal	4d22 <write>
     38c:	4785                	li	a5,1
     38e:	02f50d63          	beq	a0,a5,3c8 <badwrite+0xc0>
    printf("write failed\n");
     392:	00005517          	auipc	a0,0x5
     396:	08e50513          	addi	a0,a0,142 # 5420 <malloc+0x23c>
     39a:	593040ef          	jal	512c <printf>
    exit(1);
     39e:	4505                	li	a0,1
     3a0:	163040ef          	jal	4d02 <exit>
      printf("open junk failed\n");
     3a4:	00005517          	auipc	a0,0x5
     3a8:	06450513          	addi	a0,a0,100 # 5408 <malloc+0x224>
     3ac:	581040ef          	jal	512c <printf>
      exit(1);
     3b0:	4505                	li	a0,1
     3b2:	151040ef          	jal	4d02 <exit>
    printf("open junk failed\n");
     3b6:	00005517          	auipc	a0,0x5
     3ba:	05250513          	addi	a0,a0,82 # 5408 <malloc+0x224>
     3be:	56f040ef          	jal	512c <printf>
    exit(1);
     3c2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d2:	03250513          	addi	a0,a0,50 # 5400 <malloc+0x21c>
...
00000000000004ac <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4ca:	1b278793          	addi	a5,a5,434 # 7678 <malloc+0x2494>
     4ce:	638c                	ld	a1,0(a5)
     4d0:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fc:	f38a8a93          	addi	s5,s5,-200 # 5430 <malloc+0x24c>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58e:	eae50513          	addi	a0,a0,-338 # 5438 <malloc+0x254>
     592:	39b040ef          	jal	512c <printf>
      exit(1);
     596:	4505                	li	a0,1
     ...
     5a4:	eb050513          	addi	a0,a0,-336 # 5450 <malloc+0x26c>
     5a8:	385040ef          	jal	512c <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	eca50513          	addi	a0,a0,-310 # 5480 <malloc+0x29c>
     5be:	36f040ef          	jal	512c <printf>
      exit(1);
     5c2:	4505                	li	a0,1
     5c4:	73e040ef          	jal	4d02 <exit>
      printf("pipe() failed\n");
     5c8:	00005517          	auipc	a0,0x5
     5cc:	ee850513          	addi	a0,a0,-280 # 54b0 <malloc+0x2cc>
     5d0:	35d040ef          	jal	512c <printf>
      exit(1);
     5d4:	4505                	li	a0,1
     ...
     5e2:	ee250513          	addi	a0,a0,-286 # 54c0 <malloc+0x2dc>
     5e6:	347040ef          	jal	512c <printf>
      exit(1);
     5ea:	4505                	li	a0,1
...
00000000000005f0 <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60e:	06e78793          	addi	a5,a5,110 # 7678 <malloc+0x2494>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     642:	eb2b0b13          	addi	s6,s6,-334 # 54f0 <malloc+0x30c>
    ...
    n = write(fds[1], "x", 1);
     ...
     652:	d3ab8b93          	addi	s7,s7,-710 # 5388 <malloc+0x1a4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d8:	e2450513          	addi	a0,a0,-476 # 54f8 <malloc+0x314>
     6dc:	251040ef          	jal	512c <printf>
      exit(1);
     6e0:	4505                	li	a0,1
     ...
     6ee:	e2650513          	addi	a0,a0,-474 # 5510 <malloc+0x32c>
     6f2:	23b040ef          	jal	512c <printf>
      exit(1);
     6f6:	4505                	li	a0,1
     6f8:	60a040ef          	jal	4d02 <exit>
      printf("pipe() failed\n");
     6fc:	00005517          	auipc	a0,0x5
     700:	db450513          	addi	a0,a0,-588 # 54b0 <malloc+0x2cc>
     704:	229040ef          	jal	512c <printf>
      exit(1);
     708:	4505                	li	a0,1
     70a:	5f8040ef          	jal	4d02 <exit>
      printf("pipe write failed\n");
     70e:	00005517          	auipc	a0,0x5
     712:	e3250513          	addi	a0,a0,-462 # 5540 <malloc+0x35c>
     716:	217040ef          	jal	512c <printf>
      exit(1);
     71a:	4505                	li	a0,1
     ...
     728:	e3450513          	addi	a0,a0,-460 # 5558 <malloc+0x374>
     72c:	201040ef          	jal	512c <printf>
      exit(1);
     730:	4505                	li	a0,1
...
0000000000000736 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     74e:	c2650513          	addi	a0,a0,-986 # 5370 <malloc+0x18c>
     752:	600040ef          	jal	4d52 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     756:	60100593          	li	a1,1537
     75a:	00005517          	auipc	a0,0x5
     75e:	c1650513          	addi	a0,a0,-1002 # 5370 <malloc+0x18c>
     762:	5e0040ef          	jal	4d42 <open>
     766:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     768:	4611                	li	a2,4
     76a:	00005597          	auipc	a1,0x5
     76e:	c1658593          	addi	a1,a1,-1002 # 5380 <malloc+0x19c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     782:	bf250513          	addi	a0,a0,-1038 # 5370 <malloc+0x18c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a6:	bce50513          	addi	a0,a0,-1074 # 5370 <malloc+0x18c>
     7aa:	598040ef          	jal	4d42 <open>
     7ae:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7b0:	4581                	li	a1,0
     7b2:	00005517          	auipc	a0,0x5
     7b6:	bbe50513          	addi	a0,a0,-1090 # 5370 <malloc+0x18c>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e8:	e0458593          	addi	a1,a1,-508 # 55e8 <malloc+0x404>
     7ec:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81e:	b5650513          	addi	a0,a0,-1194 # 5370 <malloc+0x18c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     852:	d3a50513          	addi	a0,a0,-710 # 5588 <malloc+0x3a4>
     856:	0d7040ef          	jal	512c <printf>
    exit(1);
     85a:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     866:	d4650513          	addi	a0,a0,-698 # 55a8 <malloc+0x3c4>
     86a:	0c3040ef          	jal	512c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86e:	8652                	mv	a2,s4
     870:	85d6                	mv	a1,s5
     872:	00005517          	auipc	a0,0x5
     876:	d4650513          	addi	a0,a0,-698 # 55b8 <malloc+0x3d4>
     87a:	0b3040ef          	jal	512c <printf>
    exit(1);
     87e:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     88a:	d5250513          	addi	a0,a0,-686 # 55d8 <malloc+0x3f4>
     88e:	09f040ef          	jal	512c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     892:	8652                	mv	a2,s4
     894:	85d6                	mv	a1,s5
     896:	00005517          	auipc	a0,0x5
     89a:	d2250513          	addi	a0,a0,-734 # 55b8 <malloc+0x3d4>
     89e:	08f040ef          	jal	512c <printf>
    exit(1);
     8a2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8b0:	d4450513          	addi	a0,a0,-700 # 55f0 <malloc+0x40c>
     8b4:	079040ef          	jal	512c <printf>
    exit(1);
     8b8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c6:	d4e50513          	addi	a0,a0,-690 # 5610 <malloc+0x42c>
     8ca:	063040ef          	jal	512c <printf>
    exit(1);
     8ce:	4505                	li	a0,1
...
00000000000008d4 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f4:	d4050513          	addi	a0,a0,-704 # 5630 <malloc+0x44c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     90a:	d52a0a13          	addi	s4,s4,-686 # 5658 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90e:	00005b17          	auipc	s6,0x5
     912:	d82b0b13          	addi	s6,s6,-638 # 5690 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     948:	cec50513          	addi	a0,a0,-788 # 5630 <malloc+0x44c>
  ...
  if(unlink("small") < 0){
     ...
     978:	cbc50513          	addi	a0,a0,-836 # 5630 <malloc+0x44c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     9a0:	c9c50513          	addi	a0,a0,-868 # 5638 <malloc+0x454>
     9a4:	788040ef          	jal	512c <printf>
    exit(1);
     9a8:	4505                	li	a0,1
     ...
     9b6:	cb650513          	addi	a0,a0,-842 # 5668 <malloc+0x484>
     9ba:	772040ef          	jal	512c <printf>
      exit(1);
     9be:	4505                	li	a0,1
     ...
     9cc:	cd850513          	addi	a0,a0,-808 # 56a0 <malloc+0x4bc>
     9d0:	75c040ef          	jal	512c <printf>
      exit(1);
     9d4:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9e0:	cec50513          	addi	a0,a0,-788 # 56c8 <malloc+0x4e4>
     9e4:	748040ef          	jal	512c <printf>
    exit(1);
     9e8:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f4:	cf850513          	addi	a0,a0,-776 # 56e8 <malloc+0x504>
     9f8:	734040ef          	jal	512c <printf>
    exit(1);
     9fc:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a08:	cfc50513          	addi	a0,a0,-772 # 5700 <malloc+0x51c>
     a0c:	720040ef          	jal	512c <printf>
    exit(1);
     a10:	4505                	li	a0,1
...
0000000000000a16 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a34:	cf050513          	addi	a0,a0,-784 # 5720 <malloc+0x53c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a78:	cac50513          	addi	a0,a0,-852 # 5720 <malloc+0x53c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab6:	c7650513          	addi	a0,a0,-906 # 5728 <malloc+0x544>
     aba:	672040ef          	jal	512c <printf>
    exit(1);
     abe:	4505                	li	a0,1
     ...
     acc:	c8050513          	addi	a0,a0,-896 # 5748 <malloc+0x564>
     ad0:	65c040ef          	jal	512c <printf>
      exit(1);
     ad4:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ae0:	c9450513          	addi	a0,a0,-876 # 5770 <malloc+0x58c>
     ae4:	648040ef          	jal	512c <printf>
    exit(1);
     ae8:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     b00:	c2450513          	addi	a0,a0,-988 # 5720 <malloc+0x53c>
     ...
     b28:	c6c50513          	addi	a0,a0,-916 # 5790 <malloc+0x5ac>
     b2c:	600040ef          	jal	512c <printf>
        exit(1);
     b30:	4505                	li	a0,1
     ...
     b3e:	c7e50513          	addi	a0,a0,-898 # 57b8 <malloc+0x5d4>
     b42:	5ea040ef          	jal	512c <printf>
      exit(1);
     b46:	4505                	li	a0,1
     ...
     b54:	c8050513          	addi	a0,a0,-896 # 57d0 <malloc+0x5ec>
     b58:	5d4040ef          	jal	512c <printf>
      exit(1);
     b5c:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b68:	c9450513          	addi	a0,a0,-876 # 57f8 <malloc+0x614>
     b6c:	5c0040ef          	jal	512c <printf>
    exit(1);
     b70:	4505                	li	a0,1
...
0000000000000b76 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8e:	c8650513          	addi	a0,a0,-890 # 5810 <malloc+0x62c>
  ...
  write(fd, "hello", SZ);
     ...
     ba2:	ca258593          	addi	a1,a1,-862 # 5840 <malloc+0x65c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb6:	c5e50513          	addi	a0,a0,-930 # 5810 <malloc+0x62c>
  ...
  unlink("unlinkread");
     ...
     c3e:	bd650513          	addi	a0,a0,-1066 # 5810 <malloc+0x62c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c5a:	bca50513          	addi	a0,a0,-1078 # 5820 <malloc+0x63c>
     c5e:	4ce040ef          	jal	512c <printf>
    exit(1);
     c62:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6e:	bde50513          	addi	a0,a0,-1058 # 5848 <malloc+0x664>
     c72:	4ba040ef          	jal	512c <printf>
    exit(1);
     c76:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c82:	bea50513          	addi	a0,a0,-1046 # 5868 <malloc+0x684>
     c86:	4a6040ef          	jal	512c <printf>
    exit(1);
     c8a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c96:	bfe50513          	addi	a0,a0,-1026 # 5890 <malloc+0x6ac>
     c9a:	492040ef          	jal	512c <printf>
    exit(1);
     c9e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     caa:	c0a50513          	addi	a0,a0,-1014 # 58b0 <malloc+0x6cc>
     cae:	47e040ef          	jal	512c <printf>
    exit(1);
     cb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbe:	c1650513          	addi	a0,a0,-1002 # 58d0 <malloc+0x6ec>
     cc2:	46a040ef          	jal	512c <printf>
    exit(1);
     cc6:	4505                	li	a0,1
...
0000000000000ccc <linktest>:
{
  ...
  unlink("lf1");
     ...
     cde:	c1650513          	addi	a0,a0,-1002 # 58f0 <malloc+0x70c>
     ce2:	070040ef          	jal	4d52 <unlink>
  unlink("lf2");
     ce6:	00005517          	auipc	a0,0x5
     cea:	c1250513          	addi	a0,a0,-1006 # 58f8 <malloc+0x714>
     cee:	064040ef          	jal	4d52 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf2:	20200593          	li	a1,514
     cf6:	00005517          	auipc	a0,0x5
     cfa:	bfa50513          	addi	a0,a0,-1030 # 58f0 <malloc+0x70c>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0e:	b3658593          	addi	a1,a1,-1226 # 5840 <malloc+0x65c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de6:	b1e50513          	addi	a0,a0,-1250 # 5900 <malloc+0x71c>
     dea:	342040ef          	jal	512c <printf>
    exit(1);
     dee:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     dfa:	b2250513          	addi	a0,a0,-1246 # 5918 <malloc+0x734>
     dfe:	32e040ef          	jal	512c <printf>
    exit(1);
     e02:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0e:	b2650513          	addi	a0,a0,-1242 # 5930 <malloc+0x74c>
     e12:	31a040ef          	jal	512c <printf>
    exit(1);
     e16:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e22:	b3250513          	addi	a0,a0,-1230 # 5950 <malloc+0x76c>
     e26:	306040ef          	jal	512c <printf>
    exit(1);
     e2a:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e36:	b4e50513          	addi	a0,a0,-1202 # 5980 <malloc+0x79c>
     e3a:	2f2040ef          	jal	512c <printf>
    exit(1);
     e3e:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e4a:	b5250513          	addi	a0,a0,-1198 # 5998 <malloc+0x7b4>
     e4e:	2de040ef          	jal	512c <printf>
    exit(1);
     e52:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5e:	b5650513          	addi	a0,a0,-1194 # 59b0 <malloc+0x7cc>
     e62:	2ca040ef          	jal	512c <printf>
    exit(1);
     e66:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e72:	b6a50513          	addi	a0,a0,-1174 # 59d8 <malloc+0x7f4>
     e76:	2b6040ef          	jal	512c <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e86:	b8650513          	addi	a0,a0,-1146 # 5a08 <malloc+0x824>
     e8a:	2a2040ef          	jal	512c <printf>
    exit(1);
     e8e:	4505                	li	a0,1
...
0000000000000e94 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eb0:	b7c98993          	addi	s3,s3,-1156 # 5a28 <malloc+0x844>
     eb4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb6:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee8:	b5450513          	addi	a0,a0,-1196 # 5a38 <malloc+0x854>
     eec:	240040ef          	jal	512c <printf>
      exit(1);
     ef0:	4505                	li	a0,1
...
0000000000000ef6 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f12:	b4a50513          	addi	a0,a0,-1206 # 5a58 <malloc+0x874>
     f16:	63d030ef          	jal	4d52 <unlink>
  fd = open("bd", O_CREATE);
     f1a:	20000593          	li	a1,512
     f1e:	00005517          	auipc	a0,0x5
     f22:	b3a50513          	addi	a0,a0,-1222 # 5a58 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f40:	b1ca0a13          	addi	s4,s4,-1252 # 5a58 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8c:	ad050513          	addi	a0,a0,-1328 # 5a58 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff8:	a6c50513          	addi	a0,a0,-1428 # 5a60 <malloc+0x87c>
     ffc:	130040ef          	jal	512c <printf>
    exit(1);
    1000:	4505                	li	a0,1
    ...
    1012:	a7250513          	addi	a0,a0,-1422 # 5a80 <malloc+0x89c>
    1016:	116040ef          	jal	512c <printf>
      exit(1);
    101a:	4505                	li	a0,1
    ...
    1026:	a8650513          	addi	a0,a0,-1402 # 5aa8 <malloc+0x8c4>
    102a:	102040ef          	jal	512c <printf>
      exit(1);
    102e:	4505                	li	a0,1
...
0000000000001060 <badarg>:
{
    ...
    1084:	29898993          	addi	s3,s3,664 # 5318 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
00000000000010a2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f8:	b0478793          	addi	a5,a5,-1276 # 6bf8 <malloc+0x1a14>
  ...
  if(pid == 0){
    ...
    114c:	53078793          	addi	a5,a5,1328 # 7678 <malloc+0x2494>
    ...
    1170:	1ac50513          	addi	a0,a0,428 # 5318 <malloc+0x134>
    ...
    1184:	9d050513          	addi	a0,a0,-1584 # 5b50 <malloc+0x96c>
    1188:	7a5030ef          	jal	512c <printf>
      exit(1);
    118c:	4505                	li	a0,1
    ...
    119c:	93050513          	addi	a0,a0,-1744 # 5ac8 <malloc+0x8e4>
    11a0:	78d030ef          	jal	512c <printf>
    exit(1);
    11a4:	4505                	li	a0,1
    ...
    11b4:	93850513          	addi	a0,a0,-1736 # 5ae8 <malloc+0x904>
    11b8:	775030ef          	jal	512c <printf>
    exit(1);
    11bc:	4505                	li	a0,1
    ...
    11ce:	93e50513          	addi	a0,a0,-1730 # 5b08 <malloc+0x924>
    11d2:	75b030ef          	jal	512c <printf>
    exit(1);
    11d6:	4505                	li	a0,1
    ...
    11e6:	94e50513          	addi	a0,a0,-1714 # 5b30 <malloc+0x94c>
    11ea:	743030ef          	jal	512c <printf>
    exit(1);
    11ee:	4505                	li	a0,1
    11f0:	313030ef          	jal	4d02 <exit>
    printf("fork failed\n");
    11f4:	00006517          	auipc	a0,0x6
    11f8:	f2450513          	addi	a0,a0,-220 # 7118 <malloc+0x1f34>
    11fc:	731030ef          	jal	512c <printf>
    exit(1);
    1200:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1232:	94a50513          	addi	a0,a0,-1718 # 5b78 <malloc+0x994>
    1236:	6f7030ef          	jal	512c <printf>
    exit(1);
    123a:	4505                	li	a0,1
...
0000000000001240 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1254:	12050513          	addi	a0,a0,288 # 5370 <malloc+0x18c>
  ...
  if(pid == 0){
    ...
    1284:	0f098993          	addi	s3,s3,240 # 5370 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    1288:	4a29                	li	s4,10
    128a:	00005b97          	auipc	s7,0x5
    128e:	94eb8b93          	addi	s7,s7,-1714 # 5bd8 <malloc+0x9f4>
    ...
    12f4:	8b850513          	addi	a0,a0,-1864 # 5ba8 <malloc+0x9c4>
    12f8:	635030ef          	jal	512c <printf>
    exit(1);
    12fc:	4505                	li	a0,1
    ...
    1308:	8bc50513          	addi	a0,a0,-1860 # 5bc0 <malloc+0x9dc>
    130c:	621030ef          	jal	512c <printf>
        exit(1);
    1310:	4505                	li	a0,1
    ...
    131e:	8ce50513          	addi	a0,a0,-1842 # 5be8 <malloc+0xa04>
    1322:	60b030ef          	jal	512c <printf>
        exit(1);
    1326:	4505                	li	a0,1
    ...
    1344:	030a0a13          	addi	s4,s4,48 # 5370 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    1348:	498d                	li	s3,3
    134a:	00005b97          	auipc	s7,0x5
    134e:	8beb8b93          	addi	s7,s7,-1858 # 5c08 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1352:	85da                	mv	a1,s6
    1354:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1388:	fec50513          	addi	a0,a0,-20 # 5370 <malloc+0x18c>
  ...
  exit(xstatus);
    ...
    13a2:	82250513          	addi	a0,a0,-2014 # 5bc0 <malloc+0x9dc>
    13a6:	587030ef          	jal	512c <printf>
      exit(1);
    13aa:	4505                	li	a0,1
    ...
    13bc:	85850513          	addi	a0,a0,-1960 # 5c10 <malloc+0xa2c>
    13c0:	56d030ef          	jal	512c <printf>
      exit(1);
    13c4:	4505                	li	a0,1
...
00000000000013ca <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13da:	f4278793          	addi	a5,a5,-190 # 5318 <malloc+0x134>
    13de:	fcf43023          	sd	a5,-64(s0)
    13e2:	00005797          	auipc	a5,0x5
    13e6:	84e78793          	addi	a5,a5,-1970 # 5c30 <malloc+0xa4c>
    13ea:	fcf43423          	sd	a5,-56(s0)
    13ee:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f2:	00005517          	auipc	a0,0x5
    13f6:	84650513          	addi	a0,a0,-1978 # 5c38 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    141a:	82250513          	addi	a0,a0,-2014 # 5c38 <malloc+0xa54>
    ...
    1432:	82a50513          	addi	a0,a0,-2006 # 5c58 <malloc+0xa74>
    1436:	4f7030ef          	jal	512c <printf>
      exit(1);
    143a:	4505                	li	a0,1
    ...
    1448:	76450513          	addi	a0,a0,1892 # 5ba8 <malloc+0x9c4>
    144c:	4e1030ef          	jal	512c <printf>
     exit(1);
    1450:	4505                	li	a0,1
    ...
    145c:	7e850513          	addi	a0,a0,2024 # 5c40 <malloc+0xa5c>
    1460:	4cd030ef          	jal	512c <printf>
      exit(1);
    1464:	4505                	li	a0,1
    ...
    1472:	eaa50513          	addi	a0,a0,-342 # 5318 <malloc+0x134>
  ...
  if(xstatus != 0)
    ...
    149a:	7d250513          	addi	a0,a0,2002 # 5c68 <malloc+0xa84>
    149e:	48f030ef          	jal	512c <printf>
      exit(1);
    14a2:	4505                	li	a0,1
    ...
    14ae:	7d650513          	addi	a0,a0,2006 # 5c80 <malloc+0xa9c>
    14b2:	47b030ef          	jal	512c <printf>
    14b6:	bfd1                	j	148a <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b8:	4581                	li	a1,0
    14ba:	00004517          	auipc	a0,0x4
    14be:	77e50513          	addi	a0,a0,1918 # 5c38 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14e0:	20c50513          	addi	a0,a0,524 # 56e8 <malloc+0x504>
    14e4:	449030ef          	jal	512c <printf>
    exit(1);
    14e8:	4505                	li	a0,1
    ...
    14f4:	6d050513          	addi	a0,a0,1744 # 5bc0 <malloc+0x9dc>
    14f8:	435030ef          	jal	512c <printf>
    exit(1);
    14fc:	4505                	li	a0,1
    14fe:	005030ef          	jal	4d02 <exit>
  unlink("echo-ok");
    1502:	00004517          	auipc	a0,0x4
    1506:	73650513          	addi	a0,a0,1846 # 5c38 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152c:	77050513          	addi	a0,a0,1904 # 5c98 <malloc+0xab4>
    1530:	3fd030ef          	jal	512c <printf>
    exit(1);
    1534:	4505                	li	a0,1
...
0000000000001540 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	6de50513          	addi	a0,a0,1758 # 5cb0 <malloc+0xacc>
    15da:	353030ef          	jal	512c <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42db0b13          	addi	s6,s6,1069 # 142d <exectest+0x63>
{
    ...
    1650:	67c50513          	addi	a0,a0,1660 # 5cc8 <malloc+0xae4>
    1654:	2d9030ef          	jal	512c <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	68050513          	addi	a0,a0,1664 # 5ce0 <malloc+0xafc>
    1668:	2c5030ef          	jal	512c <printf>
          return;
    ...
    1696:	66650513          	addi	a0,a0,1638 # 5cf8 <malloc+0xb14>
    169a:	293030ef          	jal	512c <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	64a50513          	addi	a0,a0,1610 # 5d18 <malloc+0xb34>
    16d6:	257030ef          	jal	512c <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	47250513          	addi	a0,a0,1138 # 5ba8 <malloc+0x9c4>
    173e:	1ef030ef          	jal	512c <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	5e650513          	addi	a0,a0,1510 # 5d30 <malloc+0xb4c>
    1752:	1db030ef          	jal	512c <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	5ea50513          	addi	a0,a0,1514 # 5d48 <malloc+0xb64>
    1766:	1c7030ef          	jal	512c <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	3ee50513          	addi	a0,a0,1006 # 5ba8 <malloc+0x9c4>
    17c2:	16b030ef          	jal	512c <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	3d650513          	addi	a0,a0,982 # 5ba8 <malloc+0x9c4>
    17da:	153030ef          	jal	512c <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	53850513          	addi	a0,a0,1336 # 5d68 <malloc+0xb84>
    1838:	0f5030ef          	jal	512c <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	4c4030ef          	jal	4d02 <exit>
{
    ...
    1870:	50c50513          	addi	a0,a0,1292 # 5d78 <malloc+0xb94>
    1874:	0b9030ef          	jal	512c <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	87250513          	addi	a0,a0,-1934 # 7118 <malloc+0x1f34>
    18ae:	07f030ef          	jal	512c <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1930:	27c50513          	addi	a0,a0,636 # 5ba8 <malloc+0x9c4>
    1934:	7f8030ef          	jal	512c <printf>
      exit(1);
    1938:	4505                	li	a0,1
    ...
    195c:	2e850513          	addi	a0,a0,744 # 5c40 <malloc+0xa5c>
    1960:	7cc030ef          	jal	512c <printf>
          exit(1);
    1964:	4505                	li	a0,1
    ...
    19bc:	3e050513          	addi	a0,a0,992 # 5d98 <malloc+0xbb4>
    19c0:	76c030ef          	jal	512c <printf>
            exit(1);
    19c4:	4505                	li	a0,1
    ...
    19da:	3da50513          	addi	a0,a0,986 # 5db0 <malloc+0xbcc>
    19de:	74e030ef          	jal	512c <printf>
        exit(1);
    19e2:	4505                	li	a0,1
    ...
    1a2a:	3b250513          	addi	a0,a0,946 # 5dd8 <malloc+0xbf4>
    1a2e:	6fe030ef          	jal	512c <printf>
        exit(1);
    1a32:	4505                	li	a0,1
...
0000000000001aa4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ac6:	8c650513          	addi	a0,a0,-1850 # 5388 <malloc+0x1a4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b06:	886b0b13          	addi	s6,s6,-1914 # 5388 <malloc+0x1a4>
      link("cat", "x");
    1b0a:	00004c97          	auipc	s9,0x4
    1b0e:	2f6c8c93          	addi	s9,s9,758 # 5e00 <malloc+0xc1c>
    ...
    1b1e:	08e50513          	addi	a0,a0,142 # 5ba8 <malloc+0x9c4>
    1b22:	60a030ef          	jal	512c <printf>
    exit(1);
    1b26:	4505                	li	a0,1
...
0000000000001b9e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bca:	28a50513          	addi	a0,a0,650 # 5e50 <malloc+0xc6c>
    1bce:	55e030ef          	jal	512c <printf>
    exit(1);
    1bd2:	4505                	li	a0,1
    ...
    1be2:	22a50513          	addi	a0,a0,554 # 5e08 <malloc+0xc24>
    1be6:	546030ef          	jal	512c <printf>
    exit(1);
    1bea:	4505                	li	a0,1
    ...
    1bf6:	22e50513          	addi	a0,a0,558 # 5e20 <malloc+0xc3c>
    1bfa:	532030ef          	jal	512c <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c0a:	23250513          	addi	a0,a0,562 # 5e38 <malloc+0xc54>
    1c0e:	51e030ef          	jal	512c <printf>
    exit(1);
    1c12:	4505                	li	a0,1
...
0000000000001c44 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cac:	f0050513          	addi	a0,a0,-256 # 5ba8 <malloc+0x9c4>
    1cb0:	47c030ef          	jal	512c <printf>
      exit(1);
    1cb4:	4505                	li	a0,1
    ...
    1cc6:	1b650513          	addi	a0,a0,438 # 5e78 <malloc+0xc94>
    1cca:	462030ef          	jal	512c <printf>
      exit(1);
    1cce:	4505                	li	a0,1
...
0000000000001cda <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d3a:	e7250513          	addi	a0,a0,-398 # 5ba8 <malloc+0x9c4>
    1d3e:	3ee030ef          	jal	512c <printf>
      exit(1);
    1d42:	4505                	li	a0,1
    ...
    1d5e:	13e50513          	addi	a0,a0,318 # 5e98 <malloc+0xcb4>
    1d62:	3ca030ef          	jal	512c <printf>
      exit(1);
    1d66:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dae:	10650513          	addi	a0,a0,262 # 5eb0 <malloc+0xccc>
    1db2:	37a030ef          	jal	512c <printf>
    exit(1);
    1db6:	4505                	li	a0,1
    ...
    1dc2:	dea50513          	addi	a0,a0,-534 # 5ba8 <malloc+0x9c4>
    1dc6:	366030ef          	jal	512c <printf>
    exit(1);
    1dca:	4505                	li	a0,1
...
0000000000001dd6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dec:	89078793          	addi	a5,a5,-1904 # 7678 <malloc+0x2494>
  ...
  exit(0);
    ...
    1e56:	08650513          	addi	a0,a0,134 # 5ed8 <malloc+0xcf4>
    1e5a:	2d2030ef          	jal	512c <printf>
      exit(0);
    1e5e:	4501                	li	a0,0
    ...
    1e6a:	d4250513          	addi	a0,a0,-702 # 5ba8 <malloc+0x9c4>
    1e6e:	2be030ef          	jal	512c <printf>
      exit(1);
    1e72:	4505                	li	a0,1
...
0000000000001e7e <manywrites>:
{
  ...
  exit(0);
    ...
    1ee4:	23850513          	addi	a0,a0,568 # 7118 <malloc+0x1f34>
    1ee8:	244030ef          	jal	512c <printf>
      exit(1);
    1eec:	4505                	li	a0,1
    ...
    1f7c:	f8050513          	addi	a0,a0,-128 # 5ef8 <malloc+0xd14>
    1f80:	1ac030ef          	jal	512c <printf>
            exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f94:	45850513          	addi	a0,a0,1112 # 53e8 <malloc+0x204>
    1f98:	194030ef          	jal	512c <printf>
            exit(1);
    1f9c:	4505                	li	a0,1
...
0000000000001fb2 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2014:	be878793          	addi	a5,a5,-1048 # 6bf8 <malloc+0x1a14>
  ...
  if(ret != -1){
    ...
    2050:	ec450513          	addi	a0,a0,-316 # 5f10 <malloc+0xd2c>
    2054:	0d8030ef          	jal	512c <printf>
    exit(1);
    2058:	4505                	li	a0,1
    ...
    2066:	a6650513          	addi	a0,a0,-1434 # 5ac8 <malloc+0x8e4>
    206a:	0c2030ef          	jal	512c <printf>
    exit(1);
    206e:	4505                	li	a0,1
    ...
    207c:	a7050513          	addi	a0,a0,-1424 # 5ae8 <malloc+0x904>
    2080:	0ac030ef          	jal	512c <printf>
    exit(1);
    2084:	4505                	li	a0,1
    ...
    2094:	a7850513          	addi	a0,a0,-1416 # 5b08 <malloc+0x924>
    2098:	094030ef          	jal	512c <printf>
    exit(1);
    209c:	4505                	li	a0,1
    ...
    20aa:	a8a50513          	addi	a0,a0,-1398 # 5b30 <malloc+0x94c>
    20ae:	07e030ef          	jal	512c <printf>
    exit(1);
    20b2:	4505                	li	a0,1
...
00000000000020b8 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20e6:	e6e50513          	addi	a0,a0,-402 # 5f50 <malloc+0xd6c>
  ...
  if(n >= 0){
    ...
    210e:	e6650513          	addi	a0,a0,-410 # 5f70 <malloc+0xd8c>
    2112:	01a030ef          	jal	512c <printf>
    exit(1);
    2116:	4505                	li	a0,1
    ...
    2124:	df850513          	addi	a0,a0,-520 # 5f18 <malloc+0xd34>
    2128:	004030ef          	jal	512c <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    2138:	dfc50513          	addi	a0,a0,-516 # 5f30 <malloc+0xd4c>
    213c:	7f1020ef          	jal	512c <printf>
    exit(1);
    2140:	4505                	li	a0,1
    2142:	3c1020ef          	jal	4d02 <exit>
    printf("open(rwsbrk) failed\n");
    2146:	00004517          	auipc	a0,0x4
    214a:	e1250513          	addi	a0,a0,-494 # 5f58 <malloc+0xd74>
    214e:	7df020ef          	jal	512c <printf>
    exit(1);
    2152:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2162:	df250513          	addi	a0,a0,-526 # 5f50 <malloc+0xd6c>
    2166:	3ed020ef          	jal	4d52 <unlink>
  fd = open("README", O_RDONLY);
    216a:	4581                	li	a1,0
    216c:	00003517          	auipc	a0,0x3
    2170:	38450513          	addi	a0,a0,900 # 54f0 <malloc+0x30c>
  ...
  if(n >= 0){
    ...
    2192:	e1250513          	addi	a0,a0,-494 # 5fa0 <malloc+0xdbc>
    2196:	797020ef          	jal	512c <printf>
    exit(1);
    219a:	4505                	li	a0,1
    219c:	367020ef          	jal	4d02 <exit>
    printf("open(rwsbrk) failed\n");
    21a0:	00004517          	auipc	a0,0x4
    21a4:	db850513          	addi	a0,a0,-584 # 5f58 <malloc+0xd74>
    21a8:	785020ef          	jal	512c <printf>
    exit(1);
    21ac:	4505                	li	a0,1
...
00000000000021be <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2212:	dba50513          	addi	a0,a0,-582 # 5fc8 <malloc+0xde4>
    2216:	717020ef          	jal	512c <printf>
    exit(1);
    221a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    226a:	d8250513          	addi	a0,a0,-638 # 5fe8 <malloc+0xe04>
    226e:	6bf020ef          	jal	512c <printf>
    exit(1);
    2272:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22b4:	d9850513          	addi	a0,a0,-616 # 6048 <malloc+0xe64>
    22b8:	675020ef          	jal	512c <printf>
    exit(1);
    22bc:	4505                	li	a0,1
    ...
    22ce:	d3e50513          	addi	a0,a0,-706 # 6008 <malloc+0xe24>
    22d2:	65b020ef          	jal	512c <printf>
      exit(1);
    22d6:	4505                	li	a0,1
    ...
    22e2:	d4a50513          	addi	a0,a0,-694 # 6028 <malloc+0xe44>
    22e6:	647020ef          	jal	512c <printf>
    exit(1);
    22ea:	4505                	li	a0,1
...
000000000000230a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e4:	c8850513          	addi	a0,a0,-888 # 6068 <malloc+0xe84>
    23e8:	545020ef          	jal	512c <printf>
    exit(1);
    23ec:	4505                	li	a0,1
    ...
    23f8:	cbc50513          	addi	a0,a0,-836 # 60b0 <malloc+0xecc>
    23fc:	531020ef          	jal	512c <printf>
    exit(1);
    2400:	4505                	li	a0,1
    ...
    2410:	cc450513          	addi	a0,a0,-828 # 60d0 <malloc+0xeec>
    2414:	519020ef          	jal	512c <printf>
    exit(1);
    2418:	4505                	li	a0,1
    ...
    2428:	cec50513          	addi	a0,a0,-788 # 6110 <malloc+0xf2c>
    242c:	501020ef          	jal	512c <printf>
    exit(1);
    2430:	4505                	li	a0,1
    ...
    243c:	d0850513          	addi	a0,a0,-760 # 6140 <malloc+0xf5c>
    2440:	4ed020ef          	jal	512c <printf>
    exit(1);
    2444:	4505                	li	a0,1
    ...
    2454:	d2850513          	addi	a0,a0,-728 # 6178 <malloc+0xf94>
    2458:	4d5020ef          	jal	512c <printf>
    exit(1);
    245c:	4505                	li	a0,1
...
0000000000002462 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2482:	d2250513          	addi	a0,a0,-734 # 61a0 <malloc+0xfbc>
    2486:	0bd020ef          	jal	4d42 <open>
    248a:	84aa                	mv	s1,a0
  unlink("sbrk");
    248c:	00004517          	auipc	a0,0x4
    2490:	d1450513          	addi	a0,a0,-748 # 61a0 <malloc+0xfbc>
  ...
  if(pipe((int *) a) != 0){
    ...
    24d0:	cdc50513          	addi	a0,a0,-804 # 61a8 <malloc+0xfc4>
    24d4:	459020ef          	jal	512c <printf>
    exit(1);
    24d8:	4505                	li	a0,1
    ...
    24e4:	ce050513          	addi	a0,a0,-800 # 61c0 <malloc+0xfdc>
    24e8:	445020ef          	jal	512c <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24f8:	7bc50513          	addi	a0,a0,1980 # 5cb0 <malloc+0xacc>
    24fc:	431020ef          	jal	512c <printf>
    exit(1);
    2500:	4505                	li	a0,1
...
0000000000002506 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    251a:	cc250513          	addi	a0,a0,-830 # 61d8 <malloc+0xff4>
  ...
  close(fd);
    ...
    2552:	67250513          	addi	a0,a0,1650 # 5bc0 <malloc+0x9dc>
    2556:	3d7020ef          	jal	512c <printf>
    exit(1);
    255a:	4505                	li	a0,1
...
0000000000002560 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2588:	b9450513          	addi	a0,a0,-1132 # 7118 <malloc+0x1f34>
    258c:	3a1020ef          	jal	512c <printf>
    exit(1);
    2590:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c2:	b5a50513          	addi	a0,a0,-1190 # 7118 <malloc+0x1f34>
    25c6:	367020ef          	jal	512c <printf>
    exit(1);
    25ca:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2602:	b1a50513          	addi	a0,a0,-1254 # 7118 <malloc+0x1f34>
    2606:	327020ef          	jal	512c <printf>
    exit(1);
    260a:	4505                	li	a0,1
...
00000000000026ee <execout>:
{
  ...
  exit(0);
    ...
    272a:	9f250513          	addi	a0,a0,-1550 # 7118 <malloc+0x1f34>
    272e:	1ff020ef          	jal	512c <printf>
      exit(1);
    2732:	4505                	li	a0,1
    ...
    2770:	bac50513          	addi	a0,a0,-1108 # 5318 <malloc+0x134>
    2774:	faa43423          	sd	a0,-88(s0)
    2778:	00003797          	auipc	a5,0x3
    277c:	c1078793          	addi	a5,a5,-1008 # 5388 <malloc+0x1a4>
...
0000000000002796 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c6:	a9e50513          	addi	a0,a0,-1378 # 6260 <malloc+0x107c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27dc:	b0050513          	addi	a0,a0,-1280 # 62d8 <malloc+0x10f4>
  ...
  unlink("12345678901234");
    ...
    2860:	98450513          	addi	a0,a0,-1660 # 61e0 <malloc+0xffc>
    2864:	0c9020ef          	jal	512c <printf>
    exit(1);
    2868:	4505                	li	a0,1
    ...
    2874:	9b850513          	addi	a0,a0,-1608 # 6228 <malloc+0x1044>
    2878:	0b5020ef          	jal	512c <printf>
    exit(1);
    287c:	4505                	li	a0,1
    ...
    2888:	a0c50513          	addi	a0,a0,-1524 # 6290 <malloc+0x10ac>
    288c:	0a1020ef          	jal	512c <printf>
    exit(1);
    2890:	4505                	li	a0,1
    ...
    289c:	a7050513          	addi	a0,a0,-1424 # 6308 <malloc+0x1124>
    28a0:	08d020ef          	jal	512c <printf>
    exit(1);
    28a4:	4505                	li	a0,1
    ...
    28b0:	abc50513          	addi	a0,a0,-1348 # 6368 <malloc+0x1184>
    28b4:	079020ef          	jal	512c <printf>
    exit(1);
    28b8:	4505                	li	a0,1
    ...
    28c4:	b0050513          	addi	a0,a0,-1280 # 63c0 <malloc+0x11dc>
    28c8:	065020ef          	jal	512c <printf>
    exit(1);
    28cc:	4505                	li	a0,1
...
00000000000028d2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    2916:	ae650513          	addi	a0,a0,-1306 # 63f8 <malloc+0x1214>
    ...
    294c:	ac050513          	addi	a0,a0,-1344 # 6408 <malloc+0x1224>
    2950:	7dc020ef          	jal	512c <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    29c4:	a3850513          	addi	a0,a0,-1480 # 63f8 <malloc+0x1214>
    29c8:	3a2020ef          	jal	4d6a <mkdir>
    29cc:	12050363          	beqz	a0,2af2 <diskfull+0x220>
  unlink("diskfulldir");
    29d0:	00004517          	auipc	a0,0x4
    29d4:	a2850513          	addi	a0,a0,-1496 # 63f8 <malloc+0x1214>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afa:	93250513          	addi	a0,a0,-1742 # 6428 <malloc+0x1244>
    2afe:	62e020ef          	jal	512c <printf>
...
0000000000002b04 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b60:	90450513          	addi	a0,a0,-1788 # 6460 <malloc+0x127c>
    2b64:	5c8020ef          	jal	512c <printf>
    exit(1);
    2b68:	4505                	li	a0,1
    ...
    2b74:	90850513          	addi	a0,a0,-1784 # 6478 <malloc+0x1294>
    2b78:	5b4020ef          	jal	512c <printf>
    exit(1);
    2b7c:	4505                	li	a0,1
    ...
    2b88:	92450513          	addi	a0,a0,-1756 # 64a8 <malloc+0x12c4>
    2b8c:	5a0020ef          	jal	512c <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    ...
    2b9c:	93850513          	addi	a0,a0,-1736 # 64d0 <malloc+0x12ec>
    2ba0:	58c020ef          	jal	512c <printf>
    exit(1);
    2ba4:	4505                	li	a0,1
...
0000000000002baa <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2bfc:	fb050513          	addi	a0,a0,-80 # 5ba8 <malloc+0x9c4>
    2c00:	52c020ef          	jal	512c <printf>
    exit(1);
    2c04:	4505                	li	a0,1
    ...
    2c10:	85450513          	addi	a0,a0,-1964 # 6460 <malloc+0x127c>
    2c14:	518020ef          	jal	512c <printf>
      exit(1);
    2c18:	4505                	li	a0,1
    ...
    2c24:	8c850513          	addi	a0,a0,-1848 # 64e8 <malloc+0x1304>
    2c28:	504020ef          	jal	512c <printf>
      exit(1);
    2c2c:	4505                	li	a0,1
    ...
    2c38:	87450513          	addi	a0,a0,-1932 # 64a8 <malloc+0x12c4>
    2c3c:	4f0020ef          	jal	512c <printf>
      exit(1);
    2c40:	4505                	li	a0,1
...
0000000000002c56 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb2:	7b250513          	addi	a0,a0,1970 # 6460 <malloc+0x127c>
    2cb6:	476020ef          	jal	512c <printf>
    exit(1);
    2cba:	4505                	li	a0,1
    ...
    2cc6:	84650513          	addi	a0,a0,-1978 # 6508 <malloc+0x1324>
    2cca:	462020ef          	jal	512c <printf>
    exit(1);
    2cce:	4505                	li	a0,1
    ...
    2cda:	85250513          	addi	a0,a0,-1966 # 6528 <malloc+0x1344>
    2cde:	44e020ef          	jal	512c <printf>
    exit(1);
    2ce2:	4505                	li	a0,1
    ...
    2cee:	85650513          	addi	a0,a0,-1962 # 6540 <malloc+0x135c>
    2cf2:	43a020ef          	jal	512c <printf>
    exit(1);
    2cf6:	4505                	li	a0,1
...
0000000000002cfc <subdir>:
{
  ...
  unlink("ff");
    ...
    2d0e:	97e50513          	addi	a0,a0,-1666 # 6688 <malloc+0x14a4>
    2d12:	040020ef          	jal	4d52 <unlink>
  if(mkdir("dd") != 0){
    2d16:	00004517          	auipc	a0,0x4
    2d1a:	84250513          	addi	a0,a0,-1982 # 6558 <malloc+0x1374>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d2e:	84e50513          	addi	a0,a0,-1970 # 6578 <malloc+0x1394>
  ...
  write(fd, "ff", 2);
    ...
    2d42:	94a58593          	addi	a1,a1,-1718 # 6688 <malloc+0x14a4>
  ...
  if(unlink("dd") >= 0){
    ...
    2d54:	80850513          	addi	a0,a0,-2040 # 6558 <malloc+0x1374>
    2d58:	7fb010ef          	jal	4d52 <unlink>
    2d5c:	2c055963          	bgez	a0,302e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d60:	00004517          	auipc	a0,0x4
    2d64:	87050513          	addi	a0,a0,-1936 # 65d0 <malloc+0x13ec>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d78:	88450513          	addi	a0,a0,-1916 # 65f8 <malloc+0x1414>
  ...
  write(fd, "FF", 2);
    ...
    2d8c:	8a058593          	addi	a1,a1,-1888 # 6628 <malloc+0x1444>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da0:	89450513          	addi	a0,a0,-1900 # 6630 <malloc+0x144c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e86:	77650513          	addi	a0,a0,1910 # 65f8 <malloc+0x1414>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9a:	97a50513          	addi	a0,a0,-1670 # 6810 <malloc+0x162c>
  ...
  if(unlink("dd") < 0){
    ...
    300c:	55850513          	addi	a0,a0,1368 # 6560 <malloc+0x137c>
    3010:	11c020ef          	jal	512c <printf>
    exit(1);
    3014:	4505                	li	a0,1
    ...
    3020:	56450513          	addi	a0,a0,1380 # 6580 <malloc+0x139c>
    3024:	108020ef          	jal	512c <printf>
    exit(1);
    3028:	4505                	li	a0,1
    ...
    3034:	57050513          	addi	a0,a0,1392 # 65a0 <malloc+0x13bc>
    3038:	0f4020ef          	jal	512c <printf>
    exit(1);
    303c:	4505                	li	a0,1
    ...
    3048:	59450513          	addi	a0,a0,1428 # 65d8 <malloc+0x13f4>
    304c:	0e0020ef          	jal	512c <printf>
    exit(1);
    3050:	4505                	li	a0,1
    ...
    305c:	5b050513          	addi	a0,a0,1456 # 6608 <malloc+0x1424>
    3060:	0cc020ef          	jal	512c <printf>
    exit(1);
    3064:	4505                	li	a0,1
    ...
    3070:	5d450513          	addi	a0,a0,1492 # 6640 <malloc+0x145c>
    3074:	0b8020ef          	jal	512c <printf>
    exit(1);
    3078:	4505                	li	a0,1
    ...
    3084:	5e050513          	addi	a0,a0,1504 # 6660 <malloc+0x147c>
    3088:	0a4020ef          	jal	512c <printf>
    exit(1);
    308c:	4505                	li	a0,1
    ...
    3098:	5fc50513          	addi	a0,a0,1532 # 6690 <malloc+0x14ac>
    309c:	090020ef          	jal	512c <printf>
    exit(1);
    30a0:	4505                	li	a0,1
    ...
    30ac:	61050513          	addi	a0,a0,1552 # 66b8 <malloc+0x14d4>
    30b0:	07c020ef          	jal	512c <printf>
    exit(1);
    30b4:	4505                	li	a0,1
    ...
    30c0:	61c50513          	addi	a0,a0,1564 # 66d8 <malloc+0x14f4>
    30c4:	068020ef          	jal	512c <printf>
    exit(1);
    30c8:	4505                	li	a0,1
    ...
    30d4:	63050513          	addi	a0,a0,1584 # 6700 <malloc+0x151c>
    30d8:	054020ef          	jal	512c <printf>
    exit(1);
    30dc:	4505                	li	a0,1
    ...
    30e8:	64450513          	addi	a0,a0,1604 # 6728 <malloc+0x1544>
    30ec:	040020ef          	jal	512c <printf>
    exit(1);
    30f0:	4505                	li	a0,1
    ...
    30fc:	66050513          	addi	a0,a0,1632 # 6758 <malloc+0x1574>
    3100:	02c020ef          	jal	512c <printf>
    exit(1);
    3104:	4505                	li	a0,1
    ...
    3110:	67c50513          	addi	a0,a0,1660 # 6788 <malloc+0x15a4>
    3114:	018020ef          	jal	512c <printf>
    exit(1);
    3118:	4505                	li	a0,1
    ...
    3124:	68050513          	addi	a0,a0,1664 # 67a0 <malloc+0x15bc>
    3128:	004020ef          	jal	512c <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    3138:	68c50513          	addi	a0,a0,1676 # 67c0 <malloc+0x15dc>
    313c:	7f1010ef          	jal	512c <printf>
    exit(1);
    3140:	4505                	li	a0,1
    ...
    314c:	69850513          	addi	a0,a0,1688 # 67e0 <malloc+0x15fc>
    3150:	7dd010ef          	jal	512c <printf>
    exit(1);
    3154:	4505                	li	a0,1
    ...
    3160:	6c450513          	addi	a0,a0,1732 # 6820 <malloc+0x163c>
    3164:	7c9010ef          	jal	512c <printf>
    exit(1);
    3168:	4505                	li	a0,1
    ...
    3174:	6e050513          	addi	a0,a0,1760 # 6850 <malloc+0x166c>
    3178:	7b5010ef          	jal	512c <printf>
    exit(1);
    317c:	4505                	li	a0,1
    ...
    3188:	6ec50513          	addi	a0,a0,1772 # 6870 <malloc+0x168c>
    318c:	7a1010ef          	jal	512c <printf>
    exit(1);
    3190:	4505                	li	a0,1
    ...
    319c:	6f850513          	addi	a0,a0,1784 # 6890 <malloc+0x16ac>
    31a0:	78d010ef          	jal	512c <printf>
    exit(1);
    31a4:	4505                	li	a0,1
    ...
    31b0:	70450513          	addi	a0,a0,1796 # 68b0 <malloc+0x16cc>
    31b4:	779010ef          	jal	512c <printf>
    exit(1);
    31b8:	4505                	li	a0,1
    ...
    31c4:	72050513          	addi	a0,a0,1824 # 68e0 <malloc+0x16fc>
    31c8:	765010ef          	jal	512c <printf>
    exit(1);
    31cc:	4505                	li	a0,1
    ...
    31d8:	73450513          	addi	a0,a0,1844 # 6908 <malloc+0x1724>
    31dc:	751010ef          	jal	512c <printf>
    exit(1);
    31e0:	4505                	li	a0,1
    ...
    31ec:	74850513          	addi	a0,a0,1864 # 6930 <malloc+0x174c>
    31f0:	73d010ef          	jal	512c <printf>
    exit(1);
    31f4:	4505                	li	a0,1
    ...
    3200:	75c50513          	addi	a0,a0,1884 # 6958 <malloc+0x1774>
    3204:	729010ef          	jal	512c <printf>
    exit(1);
    3208:	4505                	li	a0,1
    ...
    3214:	76850513          	addi	a0,a0,1896 # 6978 <malloc+0x1794>
    3218:	715010ef          	jal	512c <printf>
    exit(1);
    321c:	4505                	li	a0,1
    ...
    3228:	77450513          	addi	a0,a0,1908 # 6998 <malloc+0x17b4>
    322c:	701010ef          	jal	512c <printf>
    exit(1);
    3230:	4505                	li	a0,1
    ...
    323c:	78850513          	addi	a0,a0,1928 # 69c0 <malloc+0x17dc>
    3240:	6ed010ef          	jal	512c <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	79450513          	addi	a0,a0,1940 # 69e0 <malloc+0x17fc>
    3254:	6d9010ef          	jal	512c <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	7a050513          	addi	a0,a0,1952 # 6a00 <malloc+0x181c>
    3268:	6c5010ef          	jal	512c <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	7b450513          	addi	a0,a0,1972 # 6a28 <malloc+0x1844>
    327c:	6b1010ef          	jal	512c <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	43050513          	addi	a0,a0,1072 # 66b8 <malloc+0x14d4>
    3290:	69d010ef          	jal	512c <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	7ac50513          	addi	a0,a0,1964 # 6a48 <malloc+0x1864>
    32a4:	689010ef          	jal	512c <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	7b850513          	addi	a0,a0,1976 # 6a68 <malloc+0x1884>
    32b8:	675010ef          	jal	512c <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	7d450513          	addi	a0,a0,2004 # 6a98 <malloc+0x18b4>
    32cc:	661010ef          	jal	512c <printf>
    exit(1);
    32d0:	4505                	li	a0,1
    ...
    32dc:	7e050513          	addi	a0,a0,2016 # 6ab8 <malloc+0x18d4>
    32e0:	64d010ef          	jal	512c <printf>
    exit(1);
    32e4:	4505                	li	a0,1
...
00000000000032ea <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3376:	76650513          	addi	a0,a0,1894 # 6ad8 <malloc+0x18f4>
    337a:	5b3010ef          	jal	512c <printf>
    exit(1);
    337e:	4505                	li	a0,1
    ...
    338a:	76a50513          	addi	a0,a0,1898 # 6af0 <malloc+0x190c>
    338e:	59f010ef          	jal	512c <printf>
    exit(1);
    3392:	4505                	li	a0,1
    ...
    339e:	76e50513          	addi	a0,a0,1902 # 6b08 <malloc+0x1924>
    33a2:	58b010ef          	jal	512c <printf>
    exit(1);
    33a6:	4505                	li	a0,1
    ...
    33b2:	77250513          	addi	a0,a0,1906 # 6b20 <malloc+0x193c>
    33b6:	577010ef          	jal	512c <printf>
    exit(1);
    33ba:	4505                	li	a0,1
    ...
    33c6:	10e50513          	addi	a0,a0,270 # 64d0 <malloc+0x12ec>
    33ca:	563010ef          	jal	512c <printf>
    exit(1);
    33ce:	4505                	li	a0,1
    ...
    33da:	76a50513          	addi	a0,a0,1898 # 6b40 <malloc+0x195c>
    33de:	54f010ef          	jal	512c <printf>
    exit(1);
    33e2:	4505                	li	a0,1
    ...
    33ee:	77e50513          	addi	a0,a0,1918 # 6b68 <malloc+0x1984>
    33f2:	53b010ef          	jal	512c <printf>
    exit(1);
    33f6:	4505                	li	a0,1
    ...
    3402:	78a50513          	addi	a0,a0,1930 # 6b88 <malloc+0x19a4>
    3406:	527010ef          	jal	512c <printf>
    exit(1);
    340a:	4505                	li	a0,1
...
0000000000003410 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3426:	78650513          	addi	a0,a0,1926 # 6ba8 <malloc+0x19c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    343a:	77250513          	addi	a0,a0,1906 # 6ba8 <malloc+0x19c4>
    343e:	135010ef          	jal	4d72 <chdir>
    3442:	c569                	beqz	a0,350c <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3444:	4581                	li	a1,0
    3446:	00003517          	auipc	a0,0x3
    344a:	7aa50513          	addi	a0,a0,1962 # 6bf0 <malloc+0x1a0c>
  ...
  fd = open(".", 0);
    ...
    34ca:	53a50513          	addi	a0,a0,1338 # 5a00 <malloc+0x81c>
    34ce:	075010ef          	jal	4d42 <open>
    34d2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d4:	4605                	li	a2,1
    34d6:	00002597          	auipc	a1,0x2
    34da:	eb258593          	addi	a1,a1,-334 # 5388 <malloc+0x1a4>
  ...
  close(fd);
    ...
    34fe:	6b650513          	addi	a0,a0,1718 # 6bb0 <malloc+0x19cc>
    3502:	42b010ef          	jal	512c <printf>
    exit(1);
    3506:	4505                	li	a0,1
    ...
    3512:	6c250513          	addi	a0,a0,1730 # 6bd0 <malloc+0x19ec>
    3516:	417010ef          	jal	512c <printf>
    exit(1);
    351a:	4505                	li	a0,1
    ...
    3526:	6de50513          	addi	a0,a0,1758 # 6c00 <malloc+0x1a1c>
    352a:	403010ef          	jal	512c <printf>
    exit(1);
    352e:	4505                	li	a0,1
    ...
    353a:	6ca50513          	addi	a0,a0,1738 # 6c00 <malloc+0x1a1c>
    353e:	3ef010ef          	jal	512c <printf>
    exit(1);
    3542:	4505                	li	a0,1
    ...
    354e:	6de50513          	addi	a0,a0,1758 # 6c28 <malloc+0x1a44>
    3552:	3db010ef          	jal	512c <printf>
    exit(1);
    3556:	4505                	li	a0,1
    ...
    3562:	6f250513          	addi	a0,a0,1778 # 6c50 <malloc+0x1a6c>
    3566:	3c7010ef          	jal	512c <printf>
    exit(1);
    356a:	4505                	li	a0,1
    ...
    3576:	70650513          	addi	a0,a0,1798 # 6c78 <malloc+0x1a94>
    357a:	3b3010ef          	jal	512c <printf>
    exit(1);
    357e:	4505                	li	a0,1
    ...
    358a:	71a50513          	addi	a0,a0,1818 # 6ca0 <malloc+0x1abc>
    358e:	39f010ef          	jal	512c <printf>
    exit(1);
    3592:	4505                	li	a0,1
    ...
    359e:	72650513          	addi	a0,a0,1830 # 6cc0 <malloc+0x1adc>
    35a2:	38b010ef          	jal	512c <printf>
    exit(1);
    35a6:	4505                	li	a0,1
    ...
    35b2:	73a50513          	addi	a0,a0,1850 # 6ce8 <malloc+0x1b04>
    35b6:	377010ef          	jal	512c <printf>
    exit(1);
    35ba:	4505                	li	a0,1
...
00000000000035c0 <iref>:
{
    ...
    35e0:	724a8a93          	addi	s5,s5,1828 # 6d00 <malloc+0x1b1c>
    mkdir("");
    35e4:	00003497          	auipc	s1,0x3
    35e8:	22448493          	addi	s1,s1,548 # 6808 <malloc+0x1624>
    link("README", "");
    35ec:	00002b17          	auipc	s6,0x2
    35f0:	f04b0b13          	addi	s6,s6,-252 # 54f0 <malloc+0x30c>
    fd = open("", O_CREATE);
    35f4:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35f8:	00003997          	auipc	s3,0x3
    35fc:	60098993          	addi	s3,s3,1536 # 6bf8 <malloc+0x1a14>
    3600:	a835                	j	363c <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3602:	85de                	mv	a1,s7
    3604:	00003517          	auipc	a0,0x3
    3608:	70450513          	addi	a0,a0,1796 # 6d08 <malloc+0x1b24>
    360c:	321010ef          	jal	512c <printf>
      exit(1);
    3610:	4505                	li	a0,1
    ...
    361c:	70850513          	addi	a0,a0,1800 # 6d20 <malloc+0x1b3c>
    3620:	30d010ef          	jal	512c <printf>
      exit(1);
    3624:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3680:	ea498993          	addi	s3,s3,-348 # 6520 <malloc+0x133c>
    unlink("irefd");
    3684:	00003917          	auipc	s2,0x3
    3688:	67c90913          	addi	s2,s2,1660 # 6d00 <malloc+0x1b1c>
    chdir("..");
    368c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a0:	e2c50513          	addi	a0,a0,-468 # 64c8 <malloc+0x12e4>
...
00000000000036be <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36ce:	66e50513          	addi	a0,a0,1646 # 6d38 <malloc+0x1b54>
  ...
  if(pid == 0){
    ...
    36ea:	65250513          	addi	a0,a0,1618 # 6d38 <malloc+0x1b54>
    ...
    36fc:	66050513          	addi	a0,a0,1632 # 6d58 <malloc+0x1b74>
    3700:	22d010ef          	jal	512c <printf>
      exit(1);
    3704:	4505                	li	a0,1
    ...
    3710:	63450513          	addi	a0,a0,1588 # 6d40 <malloc+0x1b5c>
    3714:	219010ef          	jal	512c <printf>
    exit(1);
    3718:	4505                	li	a0,1
    ...
    3724:	48850513          	addi	a0,a0,1160 # 5ba8 <malloc+0x9c4>
    3728:	205010ef          	jal	512c <printf>
    exit(1);
    372c:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3742:	5fa50513          	addi	a0,a0,1530 # 6d38 <malloc+0x1b54>
    3746:	60c010ef          	jal	4d52 <unlink>
    374a:	c919                	beqz	a0,3760 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    374c:	85a6                	mv	a1,s1
    374e:	00002517          	auipc	a0,0x2
    3752:	64a50513          	addi	a0,a0,1610 # 5d98 <malloc+0xbb4>
    3756:	1d7010ef          	jal	512c <printf>
    exit(1);
    375a:	4505                	li	a0,1
...
0000000000003770 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3780:	60450513          	addi	a0,a0,1540 # 6d80 <malloc+0x1b9c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a0:	5e450513          	addi	a0,a0,1508 # 6d80 <malloc+0x1b9c>
  ...
  sleep(10); // one second
    ...
    37c8:	5a450513          	addi	a0,a0,1444 # 5d68 <malloc+0xb84>
    37cc:	161010ef          	jal	512c <printf>
    exit(1);
    37d0:	4505                	li	a0,1
    37d2:	530010ef          	jal	4d02 <exit>
      int fd = open("stopforking", 0);
    37d6:	00003497          	auipc	s1,0x3
    37da:	5aa48493          	addi	s1,s1,1450 # 6d80 <malloc+0x1b9c>
    37de:	4581                	li	a1,0
    37e0:	8526                	mv	a0,s1
    ...
    37fa:	58a50513          	addi	a0,a0,1418 # 6d80 <malloc+0x1b9c>
...
000000000000380e <killstatus>:
{
  ...
  exit(0);
    ...
    3868:	34450513          	addi	a0,a0,836 # 5ba8 <malloc+0x9c4>
    386c:	0c1010ef          	jal	512c <printf>
      exit(1);
    3870:	4505                	li	a0,1
    ...
    3882:	51250513          	addi	a0,a0,1298 # 6d90 <malloc+0x1bac>
    3886:	0a7010ef          	jal	512c <printf>
       exit(1);
    388a:	4505                	li	a0,1
...
0000000000003890 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b6:	4b650513          	addi	a0,a0,1206 # 5d68 <malloc+0xb84>
    38ba:	073010ef          	jal	512c <printf>
    exit(1);
    38be:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38d8:	2d450513          	addi	a0,a0,724 # 5ba8 <malloc+0x9c4>
    38dc:	051010ef          	jal	512c <printf>
    exit(1);
    38e0:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3908:	a8458593          	addi	a1,a1,-1404 # 5388 <malloc+0x1a4>
    ...
    392a:	28250513          	addi	a0,a0,642 # 5ba8 <malloc+0x9c4>
    392e:	7fe010ef          	jal	512c <printf>
     exit(1);
    3932:	4505                	li	a0,1
    ...
    393e:	47650513          	addi	a0,a0,1142 # 6db0 <malloc+0x1bcc>
    3942:	7ea010ef          	jal	512c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    396e:	45e50513          	addi	a0,a0,1118 # 6dc8 <malloc+0x1be4>
    3972:	7ba010ef          	jal	512c <printf>
}
  ...
  printf("kill... ");
    ...
    3992:	45250513          	addi	a0,a0,1106 # 6de0 <malloc+0x1bfc>
    3996:	796010ef          	jal	512c <printf>
  kill(pid1);
    399a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b0:	44450513          	addi	a0,a0,1092 # 6df0 <malloc+0x1c0c>
    39b4:	778010ef          	jal	512c <printf>
  wait(0);
    39b8:	4501                	li	a0,0
...
00000000000039cc <reparent>:
{
  ...
  exit(0);
    ...
    3a10:	19c50513          	addi	a0,a0,412 # 5ba8 <malloc+0x9c4>
    3a14:	718010ef          	jal	512c <printf>
      exit(1);
    3a18:	4505                	li	a0,1
    ...
    3a24:	31050513          	addi	a0,a0,784 # 5d30 <malloc+0xb4c>
    3a28:	704010ef          	jal	512c <printf>
        exit(1);
    3a2c:	4505                	li	a0,1
...
0000000000003a4c <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a88:	22c50513          	addi	a0,a0,556 # 5cb0 <malloc+0xacc>
    3a8c:	6a0010ef          	jal	512c <printf>
    exit(1);
    3a90:	4505                	li	a0,1
    ...
    3aac:	8e058593          	addi	a1,a1,-1824 # 5388 <malloc+0x1a4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3b50:	2b450513          	addi	a0,a0,692 # 6e00 <malloc+0x1c1c>
    3b54:	5d8010ef          	jal	512c <printf>
    exit(1);
    3b58:	4505                	li	a0,1
    ...
    3b64:	04850513          	addi	a0,a0,72 # 5ba8 <malloc+0x9c4>
    3b68:	5c4010ef          	jal	512c <printf>
    exit(1);
    3b6c:	4505                	li	a0,1
    ...
    3ba0:	28450513          	addi	a0,a0,644 # 6e20 <malloc+0x1c3c>
    3ba4:	588010ef          	jal	512c <printf>
    exit(1);
    3ba8:	4505                	li	a0,1
...
0000000000003bb4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3bf8:	6084                	ld	s1,0(s1)
      free(m1);
    3bfa:	564010ef          	jal	515e <free>
    while(m1){
    3bfe:	fce5                	bnez	s1,3bf6 <mem+0x42>
    m1 = malloc(1024*20);
    3c00:	6515                	lui	a0,0x5
    3c02:	5e2010ef          	jal	51e4 <malloc>
    if(m1 == 0){
    3c06:	c511                	beqz	a0,3c12 <mem+0x5e>
    free(m1);
    3c08:	556010ef          	jal	515e <free>
    exit(0);
    3c0c:	4501                	li	a0,0
    ...
    3c18:	23c50513          	addi	a0,a0,572 # 6e50 <malloc+0x1c6c>
    3c1c:	510010ef          	jal	512c <printf>
      exit(1);
    3c20:	4505                	li	a0,1
...
0000000000003c2c <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c3c:	23850513          	addi	a0,a0,568 # 6e70 <malloc+0x1c8c>
    3c40:	112010ef          	jal	4d52 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c44:	20200593          	li	a1,514
    3c48:	00003517          	auipc	a0,0x3
    3c4c:	22850513          	addi	a0,a0,552 # 6e70 <malloc+0x1c8c>
  ...
  if(pid == 0) {
    ...
    3cc0:	1c450513          	addi	a0,a0,452 # 6e80 <malloc+0x1c9c>
    3cc4:	468010ef          	jal	512c <printf>
    exit(1);
    3cc8:	4505                	li	a0,1
    ...
    3cda:	1d250513          	addi	a0,a0,466 # 6ea8 <malloc+0x1cc4>
    3cde:	44e010ef          	jal	512c <printf>
      exit(1);
    3ce2:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d12:	16250513          	addi	a0,a0,354 # 6e70 <malloc+0x1c8c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d56:	17650513          	addi	a0,a0,374 # 6ec8 <malloc+0x1ce4>
    3d5a:	3d2010ef          	jal	512c <printf>
    exit(1);
    3d5e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d86:	0ee50513          	addi	a0,a0,238 # 6e70 <malloc+0x1c8c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3da8:	14c50513          	addi	a0,a0,332 # 6ef0 <malloc+0x1d0c>
    3dac:	380010ef          	jal	512c <printf>
    exit(1);
    3db0:	4505                	li	a0,1
...
0000000000003dbc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3de0:	12c78793          	addi	a5,a5,300 # 6f08 <malloc+0x1d24>
    3de4:	f6f43823          	sd	a5,-144(s0)
    3de8:	00003797          	auipc	a5,0x3
    3dec:	12878793          	addi	a5,a5,296 # 6f10 <malloc+0x1d2c>
    3df0:	f6f43c23          	sd	a5,-136(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	12478793          	addi	a5,a5,292 # 6f18 <malloc+0x1d34>
    3dfc:	f8f43023          	sd	a5,-128(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	12078793          	addi	a5,a5,288 # 6f20 <malloc+0x1d3c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e6a:	d4250513          	addi	a0,a0,-702 # 5ba8 <malloc+0x9c4>
    3e6e:	2be010ef          	jal	512c <printf>
      exit(1);
    3e72:	4505                	li	a0,1
    ...
    3eca:	d7a50513          	addi	a0,a0,-646 # 5c40 <malloc+0xa5c>
    3ece:	25e010ef          	jal	512c <printf>
        exit(1);
    3ed2:	4505                	li	a0,1
    3ed4:	62f000ef          	jal	4d02 <exit>
          printf("write failed %d\n", n);
    3ed8:	00003517          	auipc	a0,0x3
    3edc:	05050513          	addi	a0,a0,80 # 6f28 <malloc+0x1d44>
    3ee0:	24c010ef          	jal	512c <printf>
          exit(1);
    3ee4:	4505                	li	a0,1
    ...
    3ef6:	04e50513          	addi	a0,a0,78 # 6f40 <malloc+0x1d5c>
    3efa:	232010ef          	jal	512c <printf>
          exit(1);
    3efe:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f60:	ff450513          	addi	a0,a0,-12 # 6f50 <malloc+0x1d6c>
    3f64:	1c8010ef          	jal	512c <printf>
      exit(1);
    3f68:	4505                	li	a0,1
...
0000000000003f8c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fce:	f9ed0d13          	addi	s10,s10,-98 # 6f68 <malloc+0x1d84>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    4022:	f5250513          	addi	a0,a0,-174 # 6f70 <malloc+0x1d8c>
    4026:	106010ef          	jal	512c <printf>
        exit(1);
    402a:	4505                	li	a0,1
    ...
    4038:	f3450513          	addi	a0,a0,-204 # 6f68 <malloc+0x1d84>
  ...
  fd = open(".", 0);
    ...
    4060:	9a450513          	addi	a0,a0,-1628 # 5a00 <malloc+0x81c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40ce:	ec650513          	addi	a0,a0,-314 # 6f90 <malloc+0x1dac>
    40d2:	05a010ef          	jal	512c <printf>
        exit(1);
    40d6:	4505                	li	a0,1
    ...
    40e6:	ece50513          	addi	a0,a0,-306 # 6fb0 <malloc+0x1dcc>
    40ea:	042010ef          	jal	512c <printf>
        exit(1);
    40ee:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    411a:	ec250513          	addi	a0,a0,-318 # 6fd8 <malloc+0x1df4>
    411e:	00e010ef          	jal	512c <printf>
    exit(1);
    4122:	4505                	li	a0,1
    ...
    412e:	a7e50513          	addi	a0,a0,-1410 # 5ba8 <malloc+0x9c4>
    4132:	7fb000ef          	jal	512c <printf>
      exit(1);
    4136:	4505                	li	a0,1
...
000000000000426e <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4288:	d8c50513          	addi	a0,a0,-628 # 7010 <malloc+0x1e2c>
    428c:	2c7000ef          	jal	4d52 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4290:	20200593          	li	a1,514
    4294:	00003517          	auipc	a0,0x3
    4298:	d7c50513          	addi	a0,a0,-644 # 7010 <malloc+0x1e2c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42e0:	d3450513          	addi	a0,a0,-716 # 7010 <malloc+0x1e2c>
  ...
  for(i = 0; ; i++){
    ...
    433a:	cea50513          	addi	a0,a0,-790 # 7020 <malloc+0x1e3c>
    433e:	5ef000ef          	jal	512c <printf>
    exit(1);
    4342:	4505                	li	a0,1
    ...
    434e:	cf650513          	addi	a0,a0,-778 # 7040 <malloc+0x1e5c>
    4352:	5db000ef          	jal	512c <printf>
      exit(1);
    4356:	4505                	li	a0,1
    ...
    4362:	d0250513          	addi	a0,a0,-766 # 7060 <malloc+0x1e7c>
    4366:	5c7000ef          	jal	512c <printf>
    exit(1);
    436a:	4505                	li	a0,1
    ...
    4376:	d0e50513          	addi	a0,a0,-754 # 7080 <malloc+0x1e9c>
    437a:	5b3000ef          	jal	512c <printf>
      exit(1);
    437e:	4505                	li	a0,1
    ...
    438a:	d1a50513          	addi	a0,a0,-742 # 70a0 <malloc+0x1ebc>
    438e:	59f000ef          	jal	512c <printf>
      exit(1);
    4392:	4505                	li	a0,1
    ...
    439e:	d1e50513          	addi	a0,a0,-738 # 70b8 <malloc+0x1ed4>
    43a2:	58b000ef          	jal	512c <printf>
      exit(1);
    43a6:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43c0:	c5450513          	addi	a0,a0,-940 # 7010 <malloc+0x1e2c>
    ...
    43e2:	cfa50513          	addi	a0,a0,-774 # 70d8 <malloc+0x1ef4>
    43e6:	547000ef          	jal	512c <printf>
    exit(1);
    43ea:	4505                	li	a0,1
...
00000000000043f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    4400:	cfc50513          	addi	a0,a0,-772 # 70f8 <malloc+0x1f14>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4426:	cd650513          	addi	a0,a0,-810 # 70f8 <malloc+0x1f14>
  ...
  close(fd);
    ...
    4480:	e9c50513          	addi	a0,a0,-356 # 5318 <malloc+0x134>
    4484:	0b7000ef          	jal	4d3a <exec>
    fd = open("bigarg-ok", O_CREATE);
    4488:	20000593          	li	a1,512
    448c:	00003517          	auipc	a0,0x3
    4490:	c6c50513          	addi	a0,a0,-916 # 70f8 <malloc+0x1f14>
    ...
    44a8:	c6450513          	addi	a0,a0,-924 # 7108 <malloc+0x1f24>
    44ac:	481000ef          	jal	512c <printf>
    exit(1);
    44b0:	4505                	li	a0,1
    ...
    44c0:	c6c50513          	addi	a0,a0,-916 # 7128 <malloc+0x1f44>
    44c4:	469000ef          	jal	512c <printf>
    exit(1);
    44c8:	4505                	li	a0,1
...
00000000000044ce <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    44f0:	c5c50513          	addi	a0,a0,-932 # 7148 <malloc+0x1f64>
    44f4:	439000ef          	jal	512c <printf>
  for(nfiles = 0; ; nfiles++){
    44f8:	4481                	li	s1,0
    name[0] = 'f';
    ...
    45a6:	bb650513          	addi	a0,a0,-1098 # 7158 <malloc+0x1f74>
    45aa:	383000ef          	jal	512c <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    45c6:	ba650513          	addi	a0,a0,-1114 # 7168 <malloc+0x1f84>
    45ca:	363000ef          	jal	512c <printf>
    name[0] = 'f';
  ...
  printf("fsfull test finished\n");
    ...
    4684:	b0850513          	addi	a0,a0,-1272 # 7188 <malloc+0x1fa4>
    4688:	2a5000ef          	jal	512c <printf>
}
    ...
    46d6:	aa650513          	addi	a0,a0,-1370 # 7178 <malloc+0x1f94>
    46da:	253000ef          	jal	512c <printf>
    close(fd);
    46de:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4700:	aa450513          	addi	a0,a0,-1372 # 71a0 <malloc+0x1fbc>
    4704:	229000ef          	jal	512c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4724:	aa850513          	addi	a0,a0,-1368 # 71c8 <malloc+0x1fe4>
    4728:	205000ef          	jal	512c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4744:	a7050513          	addi	a0,a0,-1424 # 71b0 <malloc+0x1fcc>
    4748:	1e5000ef          	jal	512c <printf>
    exit(1);
    474c:	4505                	li	a0,1
    ...
    4760:	a7450513          	addi	a0,a0,-1420 # 71d0 <malloc+0x1fec>
    4764:	1c9000ef          	jal	512c <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    47b8:	a2450513          	addi	a0,a0,-1500 # 71d8 <malloc+0x1ff4>
    47bc:	171000ef          	jal	512c <printf>
          return 1;
    47c0:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    481c:	b70a0a13          	addi	s4,s4,-1168 # 5388 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    4820:	854a                	mv	a0,s2
    ...
    4844:	9f050513          	addi	a0,a0,-1552 # 7230 <malloc+0x204c>
    4848:	0e5000ef          	jal	512c <printf>
        exit(1);
    484c:	4505                	li	a0,1
    ...
    485e:	99650513          	addi	a0,a0,-1642 # 71f0 <malloc+0x200c>
    4862:	0cb000ef          	jal	512c <printf>
    exit(1);
    4866:	4505                	li	a0,1
    ...
    4878:	99c50513          	addi	a0,a0,-1636 # 7210 <malloc+0x202c>
    487c:	0b1000ef          	jal	512c <printf>
    exit(1);
    4880:	4505                	li	a0,1
  ...
  while(1){
    ...
    48be:	99650513          	addi	a0,a0,-1642 # 7250 <malloc+0x206c>
    48c2:	06b000ef          	jal	512c <printf>
      exit(1);
    48c6:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4910:	964b8b93          	addi	s7,s7,-1692 # 7270 <malloc+0x208c>
    int free0 = countfree();
    int free1 = 0;
    ...
    492a:	962d0d13          	addi	s10,s10,-1694 # 7288 <malloc+0x20a4>
          return 1;
        }
      }
    }
    ...
    4932:	97ac8c93          	addi	s9,s9,-1670 # 72a8 <malloc+0x20c4>
    4936:	a819                	j	494c <drivetests+0x62>
        printf("usertests slow tests starting\n");
    4938:	856a                	mv	a0,s10
    493a:	7f2000ef          	jal	512c <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    49ee:	8ee58593          	addi	a1,a1,-1810 # 72d8 <malloc+0x20f4>
    49f2:	854a                	mv	a0,s2
    ...
    4a00:	8e458593          	addi	a1,a1,-1820 # 72e0 <malloc+0x20fc>
    4a04:	854a                	mv	a0,s2
    4a06:	090000ef          	jal	4a96 <strcmp>
    4a0a:	cd15                	beqz	a0,4a46 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    4a0c:	00003597          	auipc	a1,0x3
    4a10:	8dc58593          	addi	a1,a1,-1828 # 72e8 <malloc+0x2104>
    4a14:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    4a32:	8c250513          	addi	a0,a0,-1854 # 72f0 <malloc+0x210c>
    4a36:	6f6000ef          	jal	512c <printf>
    exit(1);
    4a3a:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4a56:	8ce50513          	addi	a0,a0,-1842 # 7320 <malloc+0x213c>
    4a5a:	6d2000ef          	jal	512c <printf>
  exit(0);
    4a5e:	4501                	li	a0,0
...
0000000000004dc2 <getactiveprocesses>:
...
putc(int fd, char c)
{
    4dca:	1101                	addi	sp,sp,-32
    4dcc:	ec06                	sd	ra,24(sp)
    4dce:	e822                	sd	s0,16(sp)
    4dd0:	1000                	addi	s0,sp,32
    4dd2:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4dd6:	4605                	li	a2,1
    4dd8:	fef40593          	addi	a1,s0,-17
    4ddc:	f47ff0ef          	jal	4d22 <write>
}
    4de0:	60e2                	ld	ra,24(sp)
    4de2:	6442                	ld	s0,16(sp)
    4de4:	6105                	addi	sp,sp,32
    4de6:	8082                	ret

0000000000004de8 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4de8:	7139                	addi	sp,sp,-64
    4dea:	fc06                	sd	ra,56(sp)
    4dec:	f822                	sd	s0,48(sp)
    4dee:	f426                	sd	s1,40(sp)
    4df0:	f04a                	sd	s2,32(sp)
    4df2:	ec4e                	sd	s3,24(sp)
    4df4:	0080                	addi	s0,sp,64
    4df6:	892a                	mv	s2,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4df8:	c299                	beqz	a3,4dfe <printint+0x16>
    4dfa:	0605ce63          	bltz	a1,4e76 <printint+0x8e>
  neg = 0;
    4dfe:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
    4e08:	00003817          	auipc	a6,0x3
    4e0c:	8e880813          	addi	a6,a6,-1816 # 76f0 <digits>
    4e10:	88be                	mv	a7,a5
    4e12:	0017851b          	addiw	a0,a5,1
    4e16:	87aa                	mv	a5,a0
    4e18:	02c5f73b          	remuw	a4,a1,a2
    4e1c:	1702                	slli	a4,a4,0x20
    4e1e:	9301                	srli	a4,a4,0x20
    4e20:	9742                	add	a4,a4,a6
    4e22:	00074703          	lbu	a4,0(a4)
    4e26:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4e2a:	872e                	mv	a4,a1
    4e2c:	02c5d5bb          	divuw	a1,a1,a2
    4e30:	0685                	addi	a3,a3,1
    4e32:	fcc77fe3          	bgeu	a4,a2,4e10 <printint+0x28>
  if(neg)
    4e36:	000e0c63          	beqz	t3,4e4e <printint+0x66>
    buf[i++] = '-';
    4e3a:	fd050793          	addi	a5,a0,-48
    4e3e:	00878533          	add	a0,a5,s0
    4e42:	02d00793          	li	a5,45
    4e46:	fef50823          	sb	a5,-16(a0)
    4e4a:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
    4e4e:	fff7899b          	addiw	s3,a5,-1
    4e52:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
    4e56:	fff4c583          	lbu	a1,-1(s1)
    4e5a:	854a                	mv	a0,s2
    4e5c:	f6fff0ef          	jal	4dca <putc>
  while(--i >= 0)
    4e60:	39fd                	addiw	s3,s3,-1
    4e62:	14fd                	addi	s1,s1,-1
    4e64:	fe09d9e3          	bgez	s3,4e56 <printint+0x6e>
}
    4e68:	70e2                	ld	ra,56(sp)
    4e6a:	7442                	ld	s0,48(sp)
    4e6c:	74a2                	ld	s1,40(sp)
    4e6e:	7902                	ld	s2,32(sp)
    4e70:	69e2                	ld	s3,24(sp)
    4e72:	6121                	addi	sp,sp,64
    4e74:	8082                	ret
    x = -xx;
    4e76:	40b005bb          	negw	a1,a1
    neg = 1;
    4e7a:	4e05                	li	t3,1
    x = -xx;
    4e7c:	b751                	j	4e00 <printint+0x18>

0000000000004e7e <vprintf>:
}
...
{
    4e7e:	711d                	addi	sp,sp,-96
    4e80:	ec86                	sd	ra,88(sp)
    4e82:	e8a2                	sd	s0,80(sp)
    4e84:	e4a6                	sd	s1,72(sp)
    4e86:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4e88:	0005c483          	lbu	s1,0(a1)
    4e8c:	26048663          	beqz	s1,50f8 <vprintf+0x27a>
    4e90:	e0ca                	sd	s2,64(sp)
    4e92:	fc4e                	sd	s3,56(sp)
    4e94:	f852                	sd	s4,48(sp)
    4e96:	f456                	sd	s5,40(sp)
    4e98:	f05a                	sd	s6,32(sp)
    4e9a:	ec5e                	sd	s7,24(sp)
    4e9c:	e862                	sd	s8,16(sp)
    4e9e:	e466                	sd	s9,8(sp)
    4ea0:	8b2a                	mv	s6,a0
    4ea2:	8a2e                	mv	s4,a1
    4ea4:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4eac:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4eb0:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4eb4:	06c00c93          	li	s9,108
    4eb8:	a00d                	j	4eda <vprintf+0x5c>
        putc(fd, c0);
    4eba:	85a6                	mv	a1,s1
    4ebc:	855a                	mv	a0,s6
    4ebe:	f0dff0ef          	jal	4dca <putc>
    4ec2:	a019                	j	4ec8 <vprintf+0x4a>
    } else if(state == '%'){
    4ec4:	03598363          	beq	s3,s5,4eea <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
    4ec8:	0019079b          	addiw	a5,s2,1
    4ecc:	893e                	mv	s2,a5
    4ece:	873e                	mv	a4,a5
    4ed0:	97d2                	add	a5,a5,s4
    4ed2:	0007c483          	lbu	s1,0(a5)
    4ed6:	20048963          	beqz	s1,50e8 <vprintf+0x26a>
    c0 = fmt[i] & 0xff;
    4eda:	0004879b          	sext.w	a5,s1
    if(state == 0){
    4ede:	fe0993e3          	bnez	s3,4ec4 <vprintf+0x46>
      if(c0 == '%'){
    4ee2:	fd579ce3          	bne	a5,s5,4eba <vprintf+0x3c>
        state = '%';
    4ee6:	89be                	mv	s3,a5
    4ee8:	b7c5                	j	4ec8 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4eea:	00ea06b3          	add	a3,s4,a4
    4eee:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4ef2:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4ef4:	c681                	beqz	a3,4efc <vprintf+0x7e>
    4ef6:	9752                	add	a4,a4,s4
    4ef8:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4efc:	03878e63          	beq	a5,s8,4f38 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4f00:	05978863          	beq	a5,s9,4f50 <vprintf+0xd2>
    ...
    4f04:	07500713          	li	a4,117
    4f08:	0ee78263          	beq	a5,a4,4fec <vprintf+0x16e>
    ...
    4f0c:	07800713          	li	a4,120
    4f10:	12e78463          	beq	a5,a4,5038 <vprintf+0x1ba>
    ...
    4f14:	07000713          	li	a4,112
    4f18:	14e78963          	beq	a5,a4,506a <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4f1c:	07300713          	li	a4,115
    4f20:	18e78863          	beq	a5,a4,50b0 <vprintf+0x232>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4f24:	02500713          	li	a4,37
    4f28:	04e79463          	bne	a5,a4,4f70 <vprintf+0xf2>
        putc(fd, '%');
    4f2c:	85ba                	mv	a1,a4
    4f2e:	855a                	mv	a0,s6
    4f30:	e9bff0ef          	jal	4dca <putc>
      ...
      state = 0;
    4f34:	4981                	li	s3,0
    4f36:	bf49                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4f38:	008b8493          	addi	s1,s7,8
    4f3c:	4685                	li	a3,1
    4f3e:	4629                	li	a2,10
    4f40:	000ba583          	lw	a1,0(s7)
    4f44:	855a                	mv	a0,s6
    4f46:	ea3ff0ef          	jal	4de8 <printint>
    4f4a:	8ba6                	mv	s7,s1
      state = 0;
    4f4c:	4981                	li	s3,0
    4f4e:	bfad                	j	4ec8 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4f50:	06400793          	li	a5,100
    4f54:	02f68963          	beq	a3,a5,4f86 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f58:	06c00793          	li	a5,108
    4f5c:	04f68263          	beq	a3,a5,4fa0 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4f60:	07500793          	li	a5,117
    4f64:	0af68063          	beq	a3,a5,5004 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4f68:	07800793          	li	a5,120
    4f6c:	0ef68263          	beq	a3,a5,5050 <vprintf+0x1d2>
        putc(fd, '%');
    4f70:	02500593          	li	a1,37
    4f74:	855a                	mv	a0,s6
    4f76:	e55ff0ef          	jal	4dca <putc>
        putc(fd, c0);
    4f7a:	85a6                	mv	a1,s1
    4f7c:	855a                	mv	a0,s6
    4f7e:	e4dff0ef          	jal	4dca <putc>
      state = 0;
    4f82:	4981                	li	s3,0
    4f84:	b791                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f86:	008b8493          	addi	s1,s7,8
    4f8a:	4685                	li	a3,1
    4f8c:	4629                	li	a2,10
    4f8e:	000ba583          	lw	a1,0(s7)
    4f92:	855a                	mv	a0,s6
    4f94:	e55ff0ef          	jal	4de8 <printint>
        i += 1;
    4f98:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f9a:	8ba6                	mv	s7,s1
      state = 0;
    4f9c:	4981                	li	s3,0
        i += 1;
    4f9e:	b72d                	j	4ec8 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4fa0:	06400793          	li	a5,100
    4fa4:	02f60763          	beq	a2,a5,4fd2 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4fa8:	07500793          	li	a5,117
    4fac:	06f60963          	beq	a2,a5,501e <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4fb0:	07800793          	li	a5,120
    4fb4:	faf61ee3          	bne	a2,a5,4f70 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4fc4:	855a                	mv	a0,s6
    4fc6:	e23ff0ef          	jal	4de8 <printint>
        i += 2;
    ...
    4fde:	855a                	mv	a0,s6
    4fe0:	e09ff0ef          	jal	4de8 <printint>
        i += 2;
    4fe4:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4fe6:	8ba6                	mv	s7,s1
      state = 0;
    4fe8:	4981                	li	s3,0
        i += 2;
    4fea:	bdf9                	j	4ec8 <vprintf+0x4a>
    ...
    4ff8:	855a                	mv	a0,s6
    4ffa:	defff0ef          	jal	4de8 <printint>
    4ffe:	8ba6                	mv	s7,s1
      state = 0;
    5000:	4981                	li	s3,0
    5002:	b5d9                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5010:	855a                	mv	a0,s6
    5012:	dd7ff0ef          	jal	4de8 <printint>
        i += 1;
    5016:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    5018:	8ba6                	mv	s7,s1
      state = 0;
    501a:	4981                	li	s3,0
        i += 1;
    501c:	b575                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    502a:	855a                	mv	a0,s6
    502c:	dbdff0ef          	jal	4de8 <printint>
        i += 2;
    5030:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    5032:	8ba6                	mv	s7,s1
      state = 0;
    5034:	4981                	li	s3,0
        i += 2;
    5036:	bd49                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 16, 0);
    5038:	008b8493          	addi	s1,s7,8
    503c:	4681                	li	a3,0
    503e:	4641                	li	a2,16
    5040:	000ba583          	lw	a1,0(s7)
    5044:	855a                	mv	a0,s6
    5046:	da3ff0ef          	jal	4de8 <printint>
    504a:	8ba6                	mv	s7,s1
      state = 0;
    504c:	4981                	li	s3,0
    504e:	bdad                	j	4ec8 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    505c:	855a                	mv	a0,s6
    505e:	d8bff0ef          	jal	4de8 <printint>
        i += 1;
    5062:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    5064:	8ba6                	mv	s7,s1
      state = 0;
    5066:	4981                	li	s3,0
        i += 1;
    5068:	b585                	j	4ec8 <vprintf+0x4a>
    506a:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    506c:	008b8d13          	addi	s10,s7,8
    5070:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5074:	03000593          	li	a1,48
    5078:	855a                	mv	a0,s6
    507a:	d51ff0ef          	jal	4dca <putc>
  putc(fd, 'x');
    507e:	07800593          	li	a1,120
    5082:	855a                	mv	a0,s6
    5084:	d47ff0ef          	jal	4dca <putc>
    5088:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    508a:	00002b97          	auipc	s7,0x2
    508e:	666b8b93          	addi	s7,s7,1638 # 76f0 <digits>
    5092:	03c9d793          	srli	a5,s3,0x3c
    5096:	97de                	add	a5,a5,s7
    5098:	0007c583          	lbu	a1,0(a5)
    509c:	855a                	mv	a0,s6
    509e:	d2dff0ef          	jal	4dca <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    50a2:	0992                	slli	s3,s3,0x4
    50a4:	34fd                	addiw	s1,s1,-1
    50a6:	f4f5                	bnez	s1,5092 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    50a8:	8bea                	mv	s7,s10
      state = 0;
    50aa:	4981                	li	s3,0
    50ac:	6d02                	ld	s10,0(sp)
    50ae:	bd29                	j	4ec8 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    50b0:	008b8993          	addi	s3,s7,8
    50b4:	000bb483          	ld	s1,0(s7)
    50b8:	cc91                	beqz	s1,50d4 <vprintf+0x256>
        for(; *s; s++)
    50ba:	0004c583          	lbu	a1,0(s1)
    50be:	c195                	beqz	a1,50e2 <vprintf+0x264>
          putc(fd, *s);
    50c0:	855a                	mv	a0,s6
    50c2:	d09ff0ef          	jal	4dca <putc>
        for(; *s; s++)
    50c6:	0485                	addi	s1,s1,1
    50c8:	0004c583          	lbu	a1,0(s1)
    50cc:	f9f5                	bnez	a1,50c0 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
    50ce:	8bce                	mv	s7,s3
      state = 0;
    50d0:	4981                	li	s3,0
    50d2:	bbdd                	j	4ec8 <vprintf+0x4a>
          s = "(null)";
    50d4:	00002497          	auipc	s1,0x2
    50d8:	59c48493          	addi	s1,s1,1436 # 7670 <malloc+0x248c>
        for(; *s; s++)
    50dc:	02800593          	li	a1,40
    50e0:	b7c5                	j	50c0 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
    50e2:	8bce                	mv	s7,s3
      state = 0;
    50e4:	4981                	li	s3,0
    50e6:	b3cd                	j	4ec8 <vprintf+0x4a>
    50e8:	6906                	ld	s2,64(sp)
    50ea:	79e2                	ld	s3,56(sp)
    50ec:	7a42                	ld	s4,48(sp)
    50ee:	7aa2                	ld	s5,40(sp)
    50f0:	7b02                	ld	s6,32(sp)
    50f2:	6be2                	ld	s7,24(sp)
    50f4:	6c42                	ld	s8,16(sp)
    50f6:	6ca2                	ld	s9,8(sp)
    }
  }
}
    50f8:	60e6                	ld	ra,88(sp)
    50fa:	6446                	ld	s0,80(sp)
    50fc:	64a6                	ld	s1,72(sp)
    50fe:	6125                	addi	sp,sp,96
    5100:	8082                	ret

0000000000005102 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5102:	715d                	addi	sp,sp,-80
    5104:	ec06                	sd	ra,24(sp)
    5106:	e822                	sd	s0,16(sp)
    5108:	1000                	addi	s0,sp,32
    510a:	e010                	sd	a2,0(s0)
    510c:	e414                	sd	a3,8(s0)
    510e:	e818                	sd	a4,16(s0)
    5110:	ec1c                	sd	a5,24(s0)
    5112:	03043023          	sd	a6,32(s0)
    5116:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    511a:	8622                	mv	a2,s0
    511c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5120:	d5fff0ef          	jal	4e7e <vprintf>
}
    5124:	60e2                	ld	ra,24(sp)
    5126:	6442                	ld	s0,16(sp)
    5128:	6161                	addi	sp,sp,80
    512a:	8082                	ret

000000000000512c <printf>:

void
printf(const char *fmt, ...)
{
    512c:	711d                	addi	sp,sp,-96
    512e:	ec06                	sd	ra,24(sp)
    5130:	e822                	sd	s0,16(sp)
    5132:	1000                	addi	s0,sp,32
    5134:	e40c                	sd	a1,8(s0)
    5136:	e810                	sd	a2,16(s0)
    5138:	ec14                	sd	a3,24(s0)
    513a:	f018                	sd	a4,32(s0)
    513c:	f41c                	sd	a5,40(s0)
    513e:	03043823          	sd	a6,48(s0)
    5142:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5146:	00840613          	addi	a2,s0,8
    514a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    514e:	85aa                	mv	a1,a0
    5150:	4505                	li	a0,1
    5152:	d2dff0ef          	jal	4e7e <vprintf>
}
    5156:	60e2                	ld	ra,24(sp)
    5158:	6442                	ld	s0,16(sp)
    515a:	6125                	addi	sp,sp,96
    515c:	8082                	ret

000000000000515e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5160:	e406                	sd	ra,8(sp)
    5162:	e022                	sd	s0,0(sp)
    5164:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5166:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    516a:	00003797          	auipc	a5,0x3
    516e:	2e67b783          	ld	a5,742(a5) # 8450 <freep>
    5172:	a02d                	j	519c <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5174:	4618                	lw	a4,8(a2)
    5176:	9f2d                	addw	a4,a4,a1
    5178:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    517c:	6398                	ld	a4,0(a5)
    517e:	6310                	ld	a2,0(a4)
    5180:	a83d                	j	51be <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5182:	ff852703          	lw	a4,-8(a0)
    5186:	9f31                	addw	a4,a4,a2
    5188:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    518a:	ff053683          	ld	a3,-16(a0)
    518e:	a091                	j	51d2 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5190:	6398                	ld	a4,0(a5)
    5192:	00e7e463          	bltu	a5,a4,519a <free+0x3c>
    5196:	00e6ea63          	bltu	a3,a4,51aa <free+0x4c>
{
    519a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    519c:	fed7fae3          	bgeu	a5,a3,5190 <free+0x32>
    51a0:	6398                	ld	a4,0(a5)
    51a2:	00e6e463          	bltu	a3,a4,51aa <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    51a6:	fee7eae3          	bltu	a5,a4,519a <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    ...
    51ba:	fae60de3          	beq	a2,a4,5174 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    51ce:	fae68ae3          	beq	a3,a4,5182 <free+0x24>
    p->s.ptr = bp->s.ptr;
    51d2:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    51d4:	00003717          	auipc	a4,0x3
    51d8:	26f73e23          	sd	a5,636(a4) # 8450 <freep>
}
...
malloc(uint nbytes)
{
    51e4:	7139                	addi	sp,sp,-64
    51e6:	fc06                	sd	ra,56(sp)
    51e8:	f822                	sd	s0,48(sp)
    51ea:	f04a                	sd	s2,32(sp)
    51ec:	ec4e                	sd	s3,24(sp)
    51ee:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    51f0:	02051993          	slli	s3,a0,0x20
    51f4:	0209d993          	srli	s3,s3,0x20
    51f8:	09bd                	addi	s3,s3,15
    51fa:	0049d993          	srli	s3,s3,0x4
    51fe:	2985                	addiw	s3,s3,1
    5200:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    5202:	00003517          	auipc	a0,0x3
    5206:	24e53503          	ld	a0,590(a0) # 8450 <freep>
    520a:	c905                	beqz	a0,523a <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    520c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    520e:	4798                	lw	a4,8(a5)
    5210:	09377663          	bgeu	a4,s3,529c <malloc+0xb8>
  ...
  if(nu < 4096)
    521c:	8a4e                	mv	s4,s3
    521e:	6705                	lui	a4,0x1
    5220:	00e9f363          	bgeu	s3,a4,5226 <malloc+0x42>
    5224:	6a05                	lui	s4,0x1
    5226:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    522a:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    522e:	00003497          	auipc	s1,0x3
    5232:	22248493          	addi	s1,s1,546 # 8450 <freep>
  if(p == (char*)-1)
    5236:	5afd                	li	s5,-1
    5238:	a83d                	j	5276 <malloc+0x92>
    523a:	f426                	sd	s1,40(sp)
    523c:	e852                	sd	s4,16(sp)
    523e:	e456                	sd	s5,8(sp)
    5240:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5242:	0000a797          	auipc	a5,0xa
    5246:	a3678793          	addi	a5,a5,-1482 # ec78 <base>
    524a:	00003717          	auipc	a4,0x3
    524e:	20f73323          	sd	a5,518(a4) # 8450 <freep>
    5252:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5254:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5258:	b7d1                	j	521c <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    525a:	6398                	ld	a4,0(a5)
    525c:	e118                	sd	a4,0(a0)
    525e:	a899                	j	52b4 <malloc+0xd0>
  hp->s.size = nu;
    5260:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5264:	0541                	addi	a0,a0,16
    5266:	ef9ff0ef          	jal	515e <free>
  return freep;
    526a:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    526c:	c125                	beqz	a0,52cc <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    526e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5270:	4798                	lw	a4,8(a5)
    5272:	03277163          	bgeu	a4,s2,5294 <malloc+0xb0>
    if(p == freep)
    5276:	6098                	ld	a4,0(s1)
    5278:	853e                	mv	a0,a5
    527a:	fef71ae3          	bne	a4,a5,526e <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    527e:	8552                	mv	a0,s4
    5280:	b0bff0ef          	jal	4d8a <sbrk>
  if(p == (char*)-1)
    5284:	fd551ee3          	bne	a0,s5,5260 <malloc+0x7c>
        return 0;
    5288:	4501                	li	a0,0
    528a:	74a2                	ld	s1,40(sp)
    528c:	6a42                	ld	s4,16(sp)
    528e:	6aa2                	ld	s5,8(sp)
    5290:	6b02                	ld	s6,0(sp)
    5292:	a03d                	j	52c0 <malloc+0xdc>
    5294:	74a2                	ld	s1,40(sp)
    5296:	6a42                	ld	s4,16(sp)
    5298:	6aa2                	ld	s5,8(sp)
    529a:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    529c:	fae90fe3          	beq	s2,a4,525a <malloc+0x76>
        p->s.size -= nunits;
    52a0:	4137073b          	subw	a4,a4,s3
    52a4:	c798                	sw	a4,8(a5)
        p += p->s.size;
    52a6:	02071693          	slli	a3,a4,0x20
    52aa:	01c6d713          	srli	a4,a3,0x1c
    52ae:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    52b0:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    52b4:	00003717          	auipc	a4,0x3
    52b8:	18a73e23          	sd	a0,412(a4) # 8450 <freep>
      return (void*)(p + 1);
    52bc:	01078513          	addi	a0,a5,16
  }
}
    52c0:	70e2                	ld	ra,56(sp)
    52c2:	7442                	ld	s0,48(sp)
    52c4:	7902                	ld	s2,32(sp)
    52c6:	69e2                	ld	s3,24(sp)
    52c8:	6121                	addi	sp,sp,64
    52ca:	8082                	ret
    52cc:	74a2                	ld	s1,40(sp)
    52ce:	6a42                	ld	s4,16(sp)
    52d0:	6aa2                	ld	s5,8(sp)
    52d2:	6b02                	ld	s6,0(sp)
    52d4:	b7f5                	j	52c0 <malloc+0xdc>
