...
main(int argc, char *argv[])
{
  ...
  14:	8b058593          	addi	a1,a1,-1872 # 8c0 <malloc+0xf2>
  18:	4509                	li	a0,2
  ...
  42:	89a58593          	addi	a1,a1,-1894 # 8d8 <malloc+0x10a>
  46:	4509                	li	a0,2
...
00000000000003ac <getactiveprocesses>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	50680813          	addi	a6,a6,1286 # 8f8 <digits>
 3fa:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 678:	284b8b93          	addi	s7,s7,644 # 8f8 <digits>
 ...
 6c2:	23248493          	addi	s1,s1,562 # 8f0 <malloc+0x122>
        for(; *s; s++)
