...
forktest(void)
{
  ...
  34:	41050513          	addi	a0,a0,1040 # 440 <getactiveprocesses+0xe>
  ...
  56:	43e50513          	addi	a0,a0,1086 # 490 <getactiveprocesses+0x5e>
  ...
  6c:	3e850513          	addi	a0,a0,1000 # 450 <getactiveprocesses+0x1e>
  ...
  7e:	3ee50513          	addi	a0,a0,1006 # 468 <getactiveprocesses+0x36>
  ...
  ae:	3d650513          	addi	a0,a0,982 # 480 <getactiveprocesses+0x4e>
...
0000000000000432 <getactiveprocesses>:
