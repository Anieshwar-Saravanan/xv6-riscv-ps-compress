...
main(int argc, char *argv[])
{
  ...
  38:	8bcb0b13          	addi	s6,s6,-1860 # 8f0 <malloc+0xf4>
  ...
  6c:	89058593          	addi	a1,a1,-1904 # 8f8 <malloc+0xfc>
  70:	8532                	mv	a0,a2
...
00000000000003da <getactiveprocesses>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	0605ce63          	bltz	a1,48e <printint+0x8e>
  neg = 0;
 416:	4e01                	li	t3,0
    x = -xx;
  } else {
 ...
 424:	4e880813          	addi	a6,a6,1256 # 908 <digits>
 428:	88be                	mv	a7,a5
 42a:	0017851b          	addiw	a0,a5,1
 42e:	87aa                	mv	a5,a0
 430:	02c5f73b          	remuw	a4,a1,a2
 434:	1702                	slli	a4,a4,0x20
 436:	9301                	srli	a4,a4,0x20
 438:	9742                	add	a4,a4,a6
 ...
 44a:	fcc77fe3          	bgeu	a4,a2,428 <printint+0x28>
  if(neg)
 44e:	000e0c63          	beqz	t3,466 <printint+0x66>
    buf[i++] = '-';
 452:	fd050793          	addi	a5,a0,-48
 456:	00878533          	add	a0,a5,s0
 45a:	02d00793          	li	a5,45
 45e:	fef50823          	sb	a5,-16(a0)
 462:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
 466:	fff7899b          	addiw	s3,a5,-1
 46a:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
 46e:	fff4c583          	lbu	a1,-1(s1)
 472:	854a                	mv	a0,s2
 474:	f6fff0ef          	jal	3e2 <putc>
  while(--i >= 0)
 478:	39fd                	addiw	s3,s3,-1
 47a:	14fd                	addi	s1,s1,-1
 47c:	fe09d9e3          	bgez	s3,46e <printint+0x6e>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	26048663          	beqz	s1,710 <vprintf+0x27a>
 ...
 4ee:	20048963          	beqz	s1,700 <vprintf+0x26a>
    c0 = fmt[i] & 0xff;
 ...
 538:	18e78863          	beq	a5,a4,6c8 <vprintf+0x232>
 ...
 58c:	855a                	mv	a0,s6
 58e:	e55ff0ef          	jal	3e2 <putc>
        putc(fd, c0);
 592:	85a6                	mv	a1,s1
 594:	855a                	mv	a0,s6
 596:	e4dff0ef          	jal	3e2 <putc>
      state = 0;
 59a:	4981                	li	s3,0
 ...
 69a:	855a                	mv	a0,s6
 69c:	d47ff0ef          	jal	3e2 <putc>
 6a0:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 6a2:	00000b97          	auipc	s7,0x0
 6a6:	266b8b93          	addi	s7,s7,614 # 908 <digits>
 ...
 6be:	f4f5                	bnez	s1,6aa <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
 6c0:	8bea                	mv	s7,s10
      state = 0;
 6c2:	4981                	li	s3,0
 6c4:	6d02                	ld	s10,0(sp)
 6c6:	bd29                	j	4e0 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 6c8:	008b8993          	addi	s3,s7,8
 6cc:	000bb483          	ld	s1,0(s7)
 6d0:	cc91                	beqz	s1,6ec <vprintf+0x256>
        for(; *s; s++)
 6d2:	0004c583          	lbu	a1,0(s1)
 6d6:	c195                	beqz	a1,6fa <vprintf+0x264>
          putc(fd, *s);
 6d8:	855a                	mv	a0,s6
 6da:	d09ff0ef          	jal	3e2 <putc>
        for(; *s; s++)
 6de:	0485                	addi	s1,s1,1
 6e0:	0004c583          	lbu	a1,0(s1)
 6e4:	f9f5                	bnez	a1,6d8 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
 6e6:	8bce                	mv	s7,s3
      state = 0;
 6e8:	4981                	li	s3,0
 6ea:	bbdd                	j	4e0 <vprintf+0x4a>
          s = "(null)";
 6ec:	00000497          	auipc	s1,0x0
 6f0:	21448493          	addi	s1,s1,532 # 900 <malloc+0x104>
        for(; *s; s++)
 6f4:	02800593          	li	a1,40
 6f8:	b7c5                	j	6d8 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
 6fa:	8bce                	mv	s7,s3
      state = 0;
 6fc:	4981                	li	s3,0
 6fe:	b3cd                	j	4e0 <vprintf+0x4a>
...
free(void *ap)
{
 ...
 7a6:	a091                	j	7ea <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 7a8:	6398                	ld	a4,0(a5)
 7aa:	00e7e463          	bltu	a5,a4,7b2 <free+0x3c>
 7ae:	00e6ea63          	bltu	a3,a4,7c2 <free+0x4c>
{
 7b2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 7b4:	fed7fae3          	bgeu	a5,a3,7a8 <free+0x32>
 7b8:	6398                	ld	a4,0(a5)
 7ba:	00e6e463          	bltu	a3,a4,7c2 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 7be:	fee7eae3          	bltu	a5,a4,7b2 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
 ...
 7d2:	fae60de3          	beq	a2,a4,78c <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
 ...
 7e6:	fae68ae3          	beq	a3,a4,79a <free+0x24>
    p->s.ptr = bp->s.ptr;
 7ea:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
